...
int main (int argc, char *argv[])
{
    ...
    /*************************************************************************/
    //INSERT CODE HERE
    int total_size = mat_sz * sizeof(float);

    cudaMalloc((void **) &A_d, total_size);
    cudaMalloc((void **) &B_d, total_size);
    cudaMalloc((void **) &C_d, total_size);
    ...
    /*************************************************************************/
    //INSERT CODE HERE
    cudaMemcpy(A_d, A_h, total_size, cudaMemcpyHostToDevice);
    cudaMemcpy(B_d, B_h, total_size, cudaMemcpyHostToDevice);
    ...
    // cudaMemcpy(C_h, A_d, total_size, cudaMemcpyDeviceToHost);
    // printf("\n %f A before  %f  %f\n", C_h[250000], C_h[999], A_h[250000]);
    ...
    /*************************************************************************/
    //INSERT CODE HERE
    cudaMemcpy(C_h, C_d, total_size, cudaMemcpyDeviceToHost);
    /*************************************************************************/
    cudaDeviceSynchronize();
    stopTime(&timer); printf("%f s\n", elapsedTime(timer));
