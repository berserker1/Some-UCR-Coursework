...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a4:	3b870713          	addi	a4,a4,952 # 858 <lock_release+0x2e>
 ...
 52e:	386b8b93          	addi	s7,s7,902 # 8b0 <digits>
 ...
 582:	2d290913          	addi	s2,s2,722 # 850 <lock_release+0x26>
        while(*s != 0){
...
00000000000007be <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 7d4:	f08080e7          	jalr	-248(ra) # 6d8 <malloc>
  int tid = clone(st_ptr);
 7d8:	00000097          	auipc	ra,0x0
 7dc:	b78080e7          	jalr	-1160(ra) # 350 <clone>

  // For a child process, call the start_routine function with arg, i.e. tid = 0.
  if (tid == 0) {
 7e0:	c901                	beqz	a0,7f0 <thread_create+0x32>
    exit(0);
  }
 ...
 7fa:	aba080e7          	jalr	-1350(ra) # 2b0 <exit>

00000000000007fe <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 802:	0800                	addi	s0,sp,16
  lock->locked = 0;
 804:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 808:	6422                	ld	s0,8(sp)
 80a:	0141                	addi	sp,sp,16
 80c:	8082                	ret

000000000000080e <lock_acquire>:
...
void lock_acquire(struct lock_t* lock) {
 ...
 814:	4705                	li	a4,1
 816:	87ba                	mv	a5,a4
 818:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 81c:	2781                	sext.w	a5,a5
 81e:	ffe5                	bnez	a5,816 <lock_acquire+0x8>
    __sync_synchronize();
 820:	0ff0000f          	fence
}
 824:	6422                	ld	s0,8(sp)
...
void lock_release(struct lock_t* lock) {
 ...
 834:	0f50000f          	fence	iorw,ow
 838:	0805202f          	amoswap.w	zero,zero,(a0)
}
 83c:	6422                	ld	s0,8(sp)
