...
main(int argc, char *argv[])
{
  ...
  40:	85458593          	addi	a1,a1,-1964 # 890 <lock_release+0x1a>
  44:	4509                	li	a0,2
  ...
  5e:	84e58593          	addi	a1,a1,-1970 # 8a8 <lock_release+0x32>
  62:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f0:	3e470713          	addi	a4,a4,996 # 8d0 <lock_release+0x5a>
 ...
 5ce:	2fe90913          	addi	s2,s2,766 # 8c8 <lock_release+0x52>
        while(*s != 0){
...
000000000000080a <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 820:	f08080e7          	jalr	-248(ra) # 724 <malloc>
  int tid = clone(st_ptr);
 824:	00000097          	auipc	ra,0x0
 828:	b78080e7          	jalr	-1160(ra) # 39c <clone>

  // For a child process, call the start_routine function with arg, i.e. tid = 0.
  if (tid == 0) {
 82c:	c901                	beqz	a0,83c <thread_create+0x32>
    exit(0);
  }
 ...
 846:	aba080e7          	jalr	-1350(ra) # 2fc <exit>

000000000000084a <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 84e:	0800                	addi	s0,sp,16
  lock->locked = 0;
 850:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 854:	6422                	ld	s0,8(sp)
 856:	0141                	addi	sp,sp,16
 858:	8082                	ret

000000000000085a <lock_acquire>:
...
void lock_acquire(struct lock_t* lock) {
 ...
 860:	4705                	li	a4,1
 862:	87ba                	mv	a5,a4
 864:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 868:	2781                	sext.w	a5,a5
 86a:	ffe5                	bnez	a5,862 <lock_acquire+0x8>
    __sync_synchronize();
 86c:	0ff0000f          	fence
}
 870:	6422                	ld	s0,8(sp)
...
void lock_release(struct lock_t* lock) {
 ...
 880:	0f50000f          	fence	iorw,ow
 884:	0805202f          	amoswap.w	zero,zero,(a0)
}
 888:	6422                	ld	s0,8(sp)
