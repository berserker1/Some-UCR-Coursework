...
wc(int fd, char *name)
{
  ...
  3c:	978a0a13          	addi	s4,s4,-1672 # 9b0 <lock_release+0x26>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  aa:	92250513          	addi	a0,a0,-1758 # 9c8 <lock_release+0x3e>
  ...
  d8:	8e450513          	addi	a0,a0,-1820 # 9b8 <lock_release+0x2e>
...
main(int argc, char *argv[])
{
 ...
 154:	88858593          	addi	a1,a1,-1912 # 9d8 <lock_release+0x4e>
 158:	4501                	li	a0,0
 ...
 174:	87050513          	addi	a0,a0,-1936 # 9e0 <lock_release+0x56>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 500:	55c50513          	addi	a0,a0,1372 # a58 <digits>
 504:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 604:	40070713          	addi	a4,a4,1024 # a00 <lock_release+0x76>
 ...
 6e2:	31a90913          	addi	s2,s2,794 # 9f8 <lock_release+0x6e>
        while(*s != 0){
...
000000000000091e <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 934:	f08080e7          	jalr	-248(ra) # 838 <malloc>
  int tid = clone(st_ptr);
 938:	00000097          	auipc	ra,0x0
 93c:	b78080e7          	jalr	-1160(ra) # 4b0 <clone>

  // For a child process, call the start_routine function with arg, i.e. tid = 0.
  if (tid == 0) {
 940:	c901                	beqz	a0,950 <thread_create+0x32>
    exit(0);
  }
 ...
 95a:	aba080e7          	jalr	-1350(ra) # 410 <exit>

000000000000095e <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 962:	0800                	addi	s0,sp,16
  lock->locked = 0;
 964:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 968:	6422                	ld	s0,8(sp)
 96a:	0141                	addi	sp,sp,16
 96c:	8082                	ret

000000000000096e <lock_acquire>:
...
void lock_acquire(struct lock_t* lock) {
 ...
 974:	4705                	li	a4,1
 976:	87ba                	mv	a5,a4
 978:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 97c:	2781                	sext.w	a5,a5
 97e:	ffe5                	bnez	a5,976 <lock_acquire+0x8>
    __sync_synchronize();
 980:	0ff0000f          	fence
}
 984:	6422                	ld	s0,8(sp)
...
void lock_release(struct lock_t* lock) {
 ...
 994:	0f50000f          	fence	iorw,ow
 998:	0805202f          	amoswap.w	zero,zero,(a0)
}
 99c:	6422                	ld	s0,8(sp)
