...
main(int argc, char *argv[])
{
  ...
  14:	87058593          	addi	a1,a1,-1936 # 880 <lock_release+0x20>
  18:	4509                	li	a0,2
  ...
  50:	84c58593          	addi	a1,a1,-1972 # 898 <lock_release+0x38>
  54:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4da:	3e270713          	addi	a4,a4,994 # 8b8 <lock_release+0x58>
 ...
 5b8:	2fc90913          	addi	s2,s2,764 # 8b0 <lock_release+0x50>
        while(*s != 0){
...
00000000000007f4 <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 80a:	f08080e7          	jalr	-248(ra) # 70e <malloc>
  int tid = clone(st_ptr);
 80e:	00000097          	auipc	ra,0x0
 812:	b78080e7          	jalr	-1160(ra) # 386 <clone>

  // For a child process, call the start_routine function with arg, i.e. tid = 0.
  if (tid == 0) {
 816:	c901                	beqz	a0,826 <thread_create+0x32>
    exit(0);
  }
 ...
 830:	aba080e7          	jalr	-1350(ra) # 2e6 <exit>

0000000000000834 <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 838:	0800                	addi	s0,sp,16
  lock->locked = 0;
 83a:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 83e:	6422                	ld	s0,8(sp)
 840:	0141                	addi	sp,sp,16
 842:	8082                	ret

0000000000000844 <lock_acquire>:
...
void lock_acquire(struct lock_t* lock) {
 ...
 84a:	4705                	li	a4,1
 84c:	87ba                	mv	a5,a4
 84e:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 852:	2781                	sext.w	a5,a5
 854:	ffe5                	bnez	a5,84c <lock_acquire+0x8>
    __sync_synchronize();
 856:	0ff0000f          	fence
}
 85a:	6422                	ld	s0,8(sp)
...
void lock_release(struct lock_t* lock) {
 ...
 86a:	0f50000f          	fence	iorw,ow
 86e:	0805202f          	amoswap.w	zero,zero,(a0)
}
 872:	6422                	ld	s0,8(sp)
