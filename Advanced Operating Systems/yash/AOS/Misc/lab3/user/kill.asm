...
main(int argc, char **argv)
{
  ...
  4c:	83858593          	addi	a1,a1,-1992 # 880 <lock_release+0x1c>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3da:	52250513          	addi	a0,a0,1314 # 8f8 <digits>
 3de:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4de:	3c670713          	addi	a4,a4,966 # 8a0 <lock_release+0x3c>
 ...
 568:	394b8b93          	addi	s7,s7,916 # 8f8 <digits>
 ...
 5bc:	2e090913          	addi	s2,s2,736 # 898 <lock_release+0x34>
        while(*s != 0){
...
00000000000007f8 <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 80e:	f08080e7          	jalr	-248(ra) # 712 <malloc>
  int tid = clone(st_ptr);
 812:	00000097          	auipc	ra,0x0
 816:	b78080e7          	jalr	-1160(ra) # 38a <clone>

  // For a child process, call the start_routine function with arg, i.e. tid = 0.
  if (tid == 0) {
 81a:	c901                	beqz	a0,82a <thread_create+0x32>
    exit(0);
  }
 ...
 834:	aba080e7          	jalr	-1350(ra) # 2ea <exit>

0000000000000838 <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 83c:	0800                	addi	s0,sp,16
  lock->locked = 0;
 83e:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 842:	6422                	ld	s0,8(sp)
 844:	0141                	addi	sp,sp,16
 846:	8082                	ret

0000000000000848 <lock_acquire>:
...
void lock_acquire(struct lock_t* lock) {
 ...
 84e:	4705                	li	a4,1
 850:	87ba                	mv	a5,a4
 852:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 856:	2781                	sext.w	a5,a5
 858:	ffe5                	bnez	a5,850 <lock_acquire+0x8>
    __sync_synchronize();
 85a:	0ff0000f          	fence
}
 85e:	6422                	ld	s0,8(sp)
...
void lock_release(struct lock_t* lock) {
 ...
 86e:	0f50000f          	fence	iorw,ow
 872:	0805202f          	amoswap.w	zero,zero,(a0)
}
 876:	6422                	ld	s0,8(sp)
