...
00000000000001ec <main>:
{
 ...
 25e:	87658593          	addi	a1,a1,-1930 # ad0 <lock_release+0x26>
 262:	4509                	li	a0,2
 ...
 294:	86050513          	addi	a0,a0,-1952 # af0 <lock_release+0x46>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 620:	54c50513          	addi	a0,a0,1356 # b68 <digits>
 624:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 724:	3f070713          	addi	a4,a4,1008 # b10 <lock_release+0x66>
 ...
 7ae:	3beb8b93          	addi	s7,s7,958 # b68 <digits>
 ...
 802:	30a90913          	addi	s2,s2,778 # b08 <lock_release+0x5e>
        while(*s != 0){
...
0000000000000a3e <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 a54:	f08080e7          	jalr	-248(ra) # 958 <malloc>
  int tid = clone(st_ptr);
 a58:	00000097          	auipc	ra,0x0
 a5c:	b78080e7          	jalr	-1160(ra) # 5d0 <clone>

  // For a child process, call the start_routine function with arg, i.e. tid = 0.
  if (tid == 0) {
 a60:	c901                	beqz	a0,a70 <thread_create+0x32>
    exit(0);
  }
 ...
 a7a:	aba080e7          	jalr	-1350(ra) # 530 <exit>

0000000000000a7e <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 a82:	0800                	addi	s0,sp,16
  lock->locked = 0;
 a84:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 a88:	6422                	ld	s0,8(sp)
 a8a:	0141                	addi	sp,sp,16
 a8c:	8082                	ret

0000000000000a8e <lock_acquire>:
...
void lock_acquire(struct lock_t* lock) {
 ...
 a94:	4705                	li	a4,1
 a96:	87ba                	mv	a5,a4
 a98:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 a9c:	2781                	sext.w	a5,a5
 a9e:	ffe5                	bnez	a5,a96 <lock_acquire+0x8>
    __sync_synchronize();
 aa0:	0ff0000f          	fence
}
 aa4:	6422                	ld	s0,8(sp)
...
void lock_release(struct lock_t* lock) {
 ...
 ab4:	0f50000f          	fence	iorw,ow
 ab8:	0805202f          	amoswap.w	zero,zero,(a0)
}
 abc:	6422                	ld	s0,8(sp)
