...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0e250513          	addi	a0,a0,226 # 6120 <lock_release+0x18>
      ...
      74:	8082                	ret
{
      ...
      84:	0c050513          	addi	a0,a0,192 # 6140 <lock_release+0x38>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0b050513          	addi	a0,a0,176 # 6158 <lock_release+0x50>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0b250513          	addi	a0,a0,178 # 6178 <lock_release+0x70>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	07a50513          	addi	a0,a0,122 # 6160 <lock_release+0x58>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	08650513          	addi	a0,a0,134 # 6188 <lock_release+0x80>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	08450513          	addi	a0,a0,132 # 61b0 <lock_release+0xa8>
     134:	00006097          	auipc	ra,0x6
     138:	aaa080e7          	jalr	-1366(ra) # 5bde <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	07050513          	addi	a0,a0,112 # 61b0 <lock_release+0xa8>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	06c58593          	addi	a1,a1,108 # 61c0 <lock_release+0xb8>
     15c:	00006097          	auipc	ra,0x6
     160:	a52080e7          	jalr	-1454(ra) # 5bae <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	04850513          	addi	a0,a0,72 # 61b0 <lock_release+0xa8>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	04c58593          	addi	a1,a1,76 # 61c8 <lock_release+0xc0>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	01c50513          	addi	a0,a0,28 # 61b0 <lock_release+0xa8>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	00650513          	addi	a0,a0,6 # 61d0 <lock_release+0xc8>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f7c50513          	addi	a0,a0,-132 # 61f8 <lock_release+0xf0>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f68a8a93          	addi	s5,s5,-152 # 61f8 <lock_release+0xf0>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	ef650513          	addi	a0,a0,-266 # 6208 <lock_release+0x100>
     ...
     338:	ef450513          	addi	a0,a0,-268 # 6228 <lock_release+0x120>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	ee250513          	addi	a0,a0,-286 # 6240 <lock_release+0x138>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	ece98993          	addi	s3,s3,-306 # 6240 <lock_release+0x138>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	e8250513          	addi	a0,a0,-382 # 6240 <lock_release+0x138>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	df258593          	addi	a1,a1,-526 # 61c8 <lock_release+0xc0>
    ...
    printf("write failed\n");
     ...
     3f0:	e7450513          	addi	a0,a0,-396 # 6260 <lock_release+0x158>
    ...
    exit(1);
     ...
     40a:	e4250513          	addi	a0,a0,-446 # 6248 <lock_release+0x140>
    ...
    printf("open junk failed\n");
     ...
     424:	e2850513          	addi	a0,a0,-472 # 6248 <lock_release+0x140>
  ...
  unlink("junk");
     ...
     448:	dfc50513          	addi	a0,a0,-516 # 6240 <lock_release+0x138>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d20a0a13          	addi	s4,s4,-736 # 6270 <lock_release+0x168>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c7c50513          	addi	a0,a0,-900 # 6278 <lock_release+0x170>
     ...
     61e:	c7650513          	addi	a0,a0,-906 # 6290 <lock_release+0x188>
     ...
     63c:	c8850513          	addi	a0,a0,-888 # 62c0 <lock_release+0x1b8>
     ...
     656:	c9e50513          	addi	a0,a0,-866 # 62f0 <lock_release+0x1e8>
     ...
     674:	c9050513          	addi	a0,a0,-880 # 6300 <lock_release+0x1f8>
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	c82a0a13          	addi	s4,s4,-894 # 6330 <lock_release+0x228>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	b12a8a93          	addi	s5,s5,-1262 # 61c8 <lock_release+0xc0>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	bdc50513          	addi	a0,a0,-1060 # 6338 <lock_release+0x230>
     ...
     77e:	bd650513          	addi	a0,a0,-1066 # 6350 <lock_release+0x248>
     ...
     798:	b5c50513          	addi	a0,a0,-1188 # 62f0 <lock_release+0x1e8>
     ...
     7b2:	bd250513          	addi	a0,a0,-1070 # 6380 <lock_release+0x278>
     ...
     7d0:	bcc50513          	addi	a0,a0,-1076 # 6398 <lock_release+0x290>
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	99e58593          	addi	a1,a1,-1634 # 61c0 <lock_release+0xb8>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	97250513          	addi	a0,a0,-1678 # 61b0 <lock_release+0xa8>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	94650513          	addi	a0,a0,-1722 # 61b0 <lock_release+0xa8>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	93250513          	addi	a0,a0,-1742 # 61b0 <lock_release+0xa8>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b6c58593          	addi	a1,a1,-1172 # 6428 <lock_release+0x320>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	8b250513          	addi	a0,a0,-1870 # 61b0 <lock_release+0xa8>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	a8650513          	addi	a0,a0,-1402 # 63c8 <lock_release+0x2c0>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	a8a50513          	addi	a0,a0,-1398 # 63e8 <lock_release+0x2e0>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     976:	a8650513          	addi	a0,a0,-1402 # 63f8 <lock_release+0x2f0>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	a8a50513          	addi	a0,a0,-1398 # 6418 <lock_release+0x310>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a6:	a5650513          	addi	a0,a0,-1450 # 63f8 <lock_release+0x2f0>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a7050513          	addi	a0,a0,-1424 # 6430 <lock_release+0x328>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a7250513          	addi	a0,a0,-1422 # 6450 <lock_release+0x348>
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a5e50513          	addi	a0,a0,-1442 # 6470 <lock_release+0x368>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a6e98993          	addi	s3,s3,-1426 # 6498 <lock_release+0x390>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	a9ea8a93          	addi	s5,s5,-1378 # 64d0 <lock_release+0x3c8>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	9f850513          	addi	a0,a0,-1544 # 6470 <lock_release+0x368>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	9bc50513          	addi	a0,a0,-1604 # 6470 <lock_release+0x368>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	99a50513          	addi	a0,a0,-1638 # 6478 <lock_release+0x370>
    ...
    exit(1);
     ...
     b00:	9ac50513          	addi	a0,a0,-1620 # 64a8 <lock_release+0x3a0>
     ...
     b1e:	9c650513          	addi	a0,a0,-1594 # 64e0 <lock_release+0x3d8>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	9d250513          	addi	a0,a0,-1582 # 6508 <lock_release+0x400>
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	9d650513          	addi	a0,a0,-1578 # 6528 <lock_release+0x420>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	9d250513          	addi	a0,a0,-1582 # 6540 <lock_release+0x438>
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	9c050513          	addi	a0,a0,-1600 # 6560 <lock_release+0x458>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	96e50513          	addi	a0,a0,-1682 # 6560 <lock_release+0x458>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	92e50513          	addi	a0,a0,-1746 # 6568 <lock_release+0x460>
    ...
    exit(1);
     ...
     c5c:	93050513          	addi	a0,a0,-1744 # 6588 <lock_release+0x480>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	93c50513          	addi	a0,a0,-1732 # 65b0 <lock_release+0x4a8>
  ...
  if(unlink("big") < 0){
     ...
     ca4:	8c050513          	addi	a0,a0,-1856 # 6560 <lock_release+0x458>
     ...
     cd0:	90450513          	addi	a0,a0,-1788 # 65d0 <lock_release+0x4c8>
     ...
     cee:	90e50513          	addi	a0,a0,-1778 # 65f8 <lock_release+0x4f0>
     ...
     d0c:	90850513          	addi	a0,a0,-1784 # 6610 <lock_release+0x508>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	91450513          	addi	a0,a0,-1772 # 6638 <lock_release+0x530>
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	8fe50513          	addi	a0,a0,-1794 # 6650 <lock_release+0x548>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	91658593          	addi	a1,a1,-1770 # 6680 <lock_release+0x578>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	8ca50513          	addi	a0,a0,-1846 # 6650 <lock_release+0x548>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	8b450513          	addi	a0,a0,-1868 # 6650 <lock_release+0x548>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	89e50513          	addi	a0,a0,-1890 # 6650 <lock_release+0x548>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	90258593          	addi	a1,a1,-1790 # 66c8 <lock_release+0x5c0>
  ...
  unlink("unlinkread");
     ...
     e32:	82250513          	addi	a0,a0,-2014 # 6650 <lock_release+0x548>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	81250513          	addi	a0,a0,-2030 # 6660 <lock_release+0x558>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	81e50513          	addi	a0,a0,-2018 # 6688 <lock_release+0x580>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	82250513          	addi	a0,a0,-2014 # 66a8 <lock_release+0x5a0>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	82e50513          	addi	a0,a0,-2002 # 66d0 <lock_release+0x5c8>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	83250513          	addi	a0,a0,-1998 # 66f0 <lock_release+0x5e8>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	83650513          	addi	a0,a0,-1994 # 6710 <lock_release+0x608>
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	74258593          	addi	a1,a1,1858 # 6680 <lock_release+0x578>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	7da58593          	addi	a1,a1,2010 # 6738 <lock_release+0x630>
     f66:	00005517          	auipc	a0,0x5
     f6a:	7ca50513          	addi	a0,a0,1994 # 6730 <lock_release+0x628>
  ...
  unlink("lf1");
     ...
     f7e:	7b650513          	addi	a0,a0,1974 # 6730 <lock_release+0x628>
     f82:	00005097          	auipc	ra,0x5
     f86:	c5c080e7          	jalr	-932(ra) # 5bde <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	7a450513          	addi	a0,a0,1956 # 6730 <lock_release+0x628>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	79650513          	addi	a0,a0,1942 # 6738 <lock_release+0x630>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	75e58593          	addi	a1,a1,1886 # 6738 <lock_release+0x630>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	74850513          	addi	a0,a0,1864 # 6738 <lock_release+0x630>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	be6080e7          	jalr	-1050(ra) # 5bde <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	73058593          	addi	a1,a1,1840 # 6730 <lock_release+0x628>
    1008:	00005517          	auipc	a0,0x5
    100c:	73050513          	addi	a0,a0,1840 # 6738 <lock_release+0x630>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	71458593          	addi	a1,a1,1812 # 6730 <lock_release+0x628>
    1024:	00006517          	auipc	a0,0x6
    1028:	81c50513          	addi	a0,a0,-2020 # 6840 <lock_release+0x738>
    ...
    104a:	6fa50513          	addi	a0,a0,1786 # 6740 <lock_release+0x638>
    ...
    1066:	6f650513          	addi	a0,a0,1782 # 6758 <lock_release+0x650>
    ...
    1082:	6f250513          	addi	a0,a0,1778 # 6770 <lock_release+0x668>
    ...
    109e:	6f650513          	addi	a0,a0,1782 # 6790 <lock_release+0x688>
    ...
    10ba:	70a50513          	addi	a0,a0,1802 # 67c0 <lock_release+0x6b8>
    ...
    10d6:	70650513          	addi	a0,a0,1798 # 67d8 <lock_release+0x6d0>
    ...
    10f2:	70250513          	addi	a0,a0,1794 # 67f0 <lock_release+0x6e8>
    ...
    110e:	70e50513          	addi	a0,a0,1806 # 6818 <lock_release+0x710>
    ...
    112a:	72250513          	addi	a0,a0,1826 # 6848 <lock_release+0x740>
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	71098993          	addi	s3,s3,1808 # 6868 <lock_release+0x760>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	6e450513          	addi	a0,a0,1764 # 6878 <lock_release+0x770>
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	69ea0a13          	addi	s4,s4,1694 # 6898 <lock_release+0x790>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	64c50513          	addi	a0,a0,1612 # 6898 <lock_release+0x790>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	5e450513          	addi	a0,a0,1508 # 68a0 <lock_release+0x798>
    ...
    12e0:	5e450513          	addi	a0,a0,1508 # 68c0 <lock_release+0x7b8>
    ...
    12fc:	5e850513          	addi	a0,a0,1512 # 68e0 <lock_release+0x7d8>
...
000000000000134a <badarg>:
{
    ...
    1368:	df498993          	addi	s3,s3,-524 # 6158 <lock_release+0x50>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	74a78793          	addi	a5,a5,1866 # 7b38 <lock_release+0x1a30>
  ...
  if(pid == 0){
    ...
    144e:	12e78793          	addi	a5,a5,302 # 8578 <lock_release+0x2470>
    ...
    1472:	cea50513          	addi	a0,a0,-790 # 6158 <lock_release+0x50>
    ...
    148a:	50250513          	addi	a0,a0,1282 # 6988 <lock_release+0x880>
    ...
    14aa:	45a50513          	addi	a0,a0,1114 # 6900 <lock_release+0x7f8>
    ...
    14ca:	45a50513          	addi	a0,a0,1114 # 6920 <lock_release+0x818>
    ...
    14ec:	45850513          	addi	a0,a0,1112 # 6940 <lock_release+0x838>
    ...
    150c:	46050513          	addi	a0,a0,1120 # 6968 <lock_release+0x860>
    ...
    1526:	8c650513          	addi	a0,a0,-1850 # 6de8 <lock_release+0xce0>
  ...
  if(st != 747){
    ...
    1570:	44450513          	addi	a0,a0,1092 # 69b0 <lock_release+0x8a8>
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a2:	c1250513          	addi	a0,a0,-1006 # 61b0 <lock_release+0xa8>
  ...
  if(pid == 0){
    ...
    15cc:	be8a0a13          	addi	s4,s4,-1048 # 61b0 <lock_release+0xa8>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	440a8a93          	addi	s5,s5,1088 # 6a10 <lock_release+0x908>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	3a050513          	addi	a0,a0,928 # 69e0 <lock_release+0x8d8>
    ...
    1660:	39c50513          	addi	a0,a0,924 # 69f8 <lock_release+0x8f0>
    ...
    167e:	3a650513          	addi	a0,a0,934 # 6a20 <lock_release+0x918>
    ...
    169c:	b18a0a13          	addi	s4,s4,-1256 # 61b0 <lock_release+0xa8>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	3a0a8a93          	addi	s5,s5,928 # 6a40 <lock_release+0x938>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	ac650513          	addi	a0,a0,-1338 # 61b0 <lock_release+0xa8>
  ...
  exit(xstatus);
    ...
    170c:	2f050513          	addi	a0,a0,752 # 69f8 <lock_release+0x8f0>
    ...
    172a:	32250513          	addi	a0,a0,802 # 6a48 <lock_release+0x940>
...
0000000000001740 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1752:	a0a78793          	addi	a5,a5,-1526 # 6158 <lock_release+0x50>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	30e78793          	addi	a5,a5,782 # 6a68 <lock_release+0x960>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	30650513          	addi	a0,a0,774 # 6a70 <lock_release+0x968>
  ...
  if(pid == 0) {
    ...
    179c:	2d850513          	addi	a0,a0,728 # 6a70 <lock_release+0x968>
    ...
    17b8:	2dc50513          	addi	a0,a0,732 # 6a90 <lock_release+0x988>
    ...
    17d4:	21050513          	addi	a0,a0,528 # 69e0 <lock_release+0x8d8>
    ...
    17f0:	28c50513          	addi	a0,a0,652 # 6a78 <lock_release+0x970>
    ...
    180e:	94e50513          	addi	a0,a0,-1714 # 6158 <lock_release+0x50>
  ...
  if(xstatus != 0)
    ...
    1842:	26250513          	addi	a0,a0,610 # 6aa0 <lock_release+0x998>
    ...
    185e:	25e50513          	addi	a0,a0,606 # 6ab8 <lock_release+0x9b0>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1872:	20250513          	addi	a0,a0,514 # 6a70 <lock_release+0x968>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	c9050513          	addi	a0,a0,-880 # 6528 <lock_release+0x420>
    ...
    18b8:	14450513          	addi	a0,a0,324 # 69f8 <lock_release+0x8f0>
  ...
  unlink("echo-ok");
    ...
    18d2:	1a250513          	addi	a0,a0,418 # 6a70 <lock_release+0x968>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	1d850513          	addi	a0,a0,472 # 6ad0 <lock_release+0x9c8>
...
000000000000191c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19bc:	13050513          	addi	a0,a0,304 # 6ae8 <lock_release+0x9e0>
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	0c250513          	addi	a0,a0,194 # 6b00 <lock_release+0x9f8>
    ...
    1a5e:	0be50513          	addi	a0,a0,190 # 6b18 <lock_release+0xa10>
    ...
    1a90:	0a450513          	addi	a0,a0,164 # 6b30 <lock_release+0xa28>
    ...
    1ad0:	08450513          	addi	a0,a0,132 # 6b50 <lock_release+0xa48>
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b42:	ea250513          	addi	a0,a0,-350 # 69e0 <lock_release+0x8d8>
    ...
    1b5e:	00e50513          	addi	a0,a0,14 # 6b68 <lock_release+0xa60>
    ...
    1b7a:	00a50513          	addi	a0,a0,10 # 6b80 <lock_release+0xa78>
...
0000000000001b9a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf2:	df250513          	addi	a0,a0,-526 # 69e0 <lock_release+0x8d8>
    ...
    1c16:	dce50513          	addi	a0,a0,-562 # 69e0 <lock_release+0x8d8>
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	f1450513          	addi	a0,a0,-236 # 6ba0 <lock_release+0xa98>
    ...
    1ca2:	ef0080e7          	jalr	-272(ra) # 5b8e <exit>
{
    ...
    1ce8:	ecc50513          	addi	a0,a0,-308 # 6bb0 <lock_release+0xaa8>
...
0000000000001cfe <reparent2>:
{
  ...
  exit(0);
    ...
    1d36:	0b650513          	addi	a0,a0,182 # 6de8 <lock_release+0xce0>
...
0000000000001d66 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	01850513          	addi	a0,a0,24 # 6de8 <lock_release+0xce0>
    ...
    1e00:	c7c50513          	addi	a0,a0,-900 # 6a78 <lock_release+0x970>
    ...
    1e72:	d6250513          	addi	a0,a0,-670 # 6bd0 <lock_release+0xac8>
    ...
    1ea6:	d4650513          	addi	a0,a0,-698 # 6be8 <lock_release+0xae0>
    ...
    1f0c:	d0850513          	addi	a0,a0,-760 # 6c10 <lock_release+0xb08>
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fac:	22050513          	addi	a0,a0,544 # 61c8 <lock_release+0xc0>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	1e4a8a93          	addi	s5,s5,484 # 61c8 <lock_release+0xc0>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	c4cb8b93          	addi	s7,s7,-948 # 6c38 <lock_release+0xb30>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	9e850513          	addi	a0,a0,-1560 # 69e0 <lock_release+0x8d8>
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20be:	b9e50513          	addi	a0,a0,-1122 # 6c58 <lock_release+0xb50>
  ...
  if(wait(0) != -1){
    ...
    2120:	b2450513          	addi	a0,a0,-1244 # 6c40 <lock_release+0xb38>
    ...
    213c:	b4850513          	addi	a0,a0,-1208 # 6c80 <lock_release+0xb78>
    ...
    2158:	b4450513          	addi	a0,a0,-1212 # 6c98 <lock_release+0xb90>
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21d8:	80c50513          	addi	a0,a0,-2036 # 69e0 <lock_release+0x8d8>
    ...
    21fa:	aba50513          	addi	a0,a0,-1350 # 6cb0 <lock_release+0xba8>
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227c:	76850513          	addi	a0,a0,1896 # 69e0 <lock_release+0x8d8>
    ...
    22a8:	a2c50513          	addi	a0,a0,-1492 # 6cd0 <lock_release+0xbc8>
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22d8:	a1450513          	addi	a0,a0,-1516 # 6ce8 <lock_release+0xbe0>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	9e250513          	addi	a0,a0,-1566 # 6ce8 <lock_release+0xbe0>
  ...
  close(fd);
    ...
    2340:	9bc70713          	addi	a4,a4,-1604 # 6cf8 <lock_release+0xbf0>
    ...
    2394:	a4850513          	addi	a0,a0,-1464 # 6dd8 <lock_release+0xcd0>
    ...
    23b8:	a4450513          	addi	a0,a0,-1468 # 6df8 <lock_release+0xcf0>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2416:	a0650513          	addi	a0,a0,-1530 # 6e18 <lock_release+0xd10>
    ...
    2432:	5b250513          	addi	a0,a0,1458 # 69e0 <lock_release+0x8d8>
...
0000000000002452 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	54450513          	addi	a0,a0,1348 # 69e0 <lock_release+0x8d8>
...
00000000000024c0 <manywrites>:
{
  ...
  exit(0);
    ...
    251c:	8d050513          	addi	a0,a0,-1840 # 6de8 <lock_release+0xce0>
    ...
    25cc:	87850513          	addi	a0,a0,-1928 # 6e40 <lock_release+0xd38>
    ...
    25ec:	c4050513          	addi	a0,a0,-960 # 6228 <lock_release+0x120>
...
000000000000260a <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2684:	4b878793          	addi	a5,a5,1208 # 7b38 <lock_release+0x1a30>
  ...
  if(ret != -1){
    ...
    26c6:	79650513          	addi	a0,a0,1942 # 6e58 <lock_release+0xd50>
    ...
    26e4:	22050513          	addi	a0,a0,544 # 6900 <lock_release+0x7f8>
    ...
    2702:	22250513          	addi	a0,a0,546 # 6920 <lock_release+0x818>
    ...
    2722:	22250513          	addi	a0,a0,546 # 6940 <lock_release+0x838>
    ...
    2740:	22c50513          	addi	a0,a0,556 # 6968 <lock_release+0x860>
...
0000000000002756 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278c:	71050513          	addi	a0,a0,1808 # 6e98 <lock_release+0xd90>
  ...
  if(n >= 0){
    ...
    27bc:	70050513          	addi	a0,a0,1792 # 6eb8 <lock_release+0xdb0>
    ...
    27d6:	68e50513          	addi	a0,a0,1678 # 6e60 <lock_release+0xd58>
    ...
    27f0:	68c50513          	addi	a0,a0,1676 # 6e78 <lock_release+0xd70>
    ...
    280a:	69a50513          	addi	a0,a0,1690 # 6ea0 <lock_release+0xd98>
  ...
  unlink("rwsbrk");
    ...
    282e:	66e50513          	addi	a0,a0,1646 # 6e98 <lock_release+0xd90>
    2832:	00003097          	auipc	ra,0x3
    2836:	3ac080e7          	jalr	940(ra) # 5bde <unlink>
  fd = open("README", O_RDONLY);
    283a:	4581                	li	a1,0
    283c:	00004517          	auipc	a0,0x4
    2840:	af450513          	addi	a0,a0,-1292 # 6330 <lock_release+0x228>
  ...
  if(n >= 0){
    ...
    286a:	68250513          	addi	a0,a0,1666 # 6ee8 <lock_release+0xde0>
    ...
    2884:	62050513          	addi	a0,a0,1568 # 6ea0 <lock_release+0xd98>
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2904:	61050513          	addi	a0,a0,1552 # 6f10 <lock_release+0xe08>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2956:	5de50513          	addi	a0,a0,1502 # 6f30 <lock_release+0xe28>
  ...
  if(c != a + 1){
    ...
    29ba:	5da50513          	addi	a0,a0,1498 # 6f90 <lock_release+0xe88>
    ...
    29dc:	57850513          	addi	a0,a0,1400 # 6f50 <lock_release+0xe48>
    ...
    29f8:	57c50513          	addi	a0,a0,1404 # 6f70 <lock_release+0xe68>
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b42:	47250513          	addi	a0,a0,1138 # 6fb0 <lock_release+0xea8>
    ...
    2b5e:	49e50513          	addi	a0,a0,1182 # 6ff8 <lock_release+0xef0>
    ...
    2b7e:	49e50513          	addi	a0,a0,1182 # 7018 <lock_release+0xf10>
    ...
    2b9e:	4be50513          	addi	a0,a0,1214 # 7058 <lock_release+0xf50>
    ...
    2bba:	4d250513          	addi	a0,a0,1234 # 7088 <lock_release+0xf80>
    ...
    2bda:	4ea50513          	addi	a0,a0,1258 # 70c0 <lock_release+0xfb8>
...
0000000000002bf0 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c14:	4d850513          	addi	a0,a0,1240 # 70e8 <lock_release+0xfe0>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fb6080e7          	jalr	-74(ra) # 5bce <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	4c650513          	addi	a0,a0,1222 # 70e8 <lock_release+0xfe0>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	47a50513          	addi	a0,a0,1146 # 70f0 <lock_release+0xfe8>
    ...
    2c96:	47650513          	addi	a0,a0,1142 # 7108 <lock_release+0x1000>
    ...
    2cb2:	e3a50513          	addi	a0,a0,-454 # 6ae8 <lock_release+0x9e0>
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	44850513          	addi	a0,a0,1096 # 7120 <lock_release+0x1018>
  ...
  close(fd);
    ...
    2d24:	cd850513          	addi	a0,a0,-808 # 69f8 <lock_release+0x8f0>
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d72:	07a50513          	addi	a0,a0,122 # 6de8 <lock_release+0xce0>
  ...
  if(pid == 0){
    ...
    2dc8:	02450513          	addi	a0,a0,36 # 6de8 <lock_release+0xce0>
  ...
  if(pid == 0){
    ...
    2e28:	fc450513          	addi	a0,a0,-60 # 6de8 <lock_release+0xce0>
...
0000000000002f5a <execout>:
{
  ...
  exit(0);
    ...
    2f9c:	e5050513          	addi	a0,a0,-432 # 6de8 <lock_release+0xce0>
    ...
    2ff0:	16c50513          	addi	a0,a0,364 # 6158 <lock_release+0x50>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	1d078793          	addi	a5,a5,464 # 61c8 <lock_release+0xc0>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    302e:	2ce50513          	addi	a0,a0,718 # 72f8 <lock_release+0x11f0>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3040:	11450513          	addi	a0,a0,276 # 7150 <lock_release+0x1048>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	15650513          	addi	a0,a0,342 # 71a8 <lock_release+0x10a0>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	1b050513          	addi	a0,a0,432 # 7220 <lock_release+0x1118>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3090:	20450513          	addi	a0,a0,516 # 7290 <lock_release+0x1188>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a2:	24a50513          	addi	a0,a0,586 # 72e8 <lock_release+0x11e0>
  ...
  unlink("12345678901234");
    ...
    3120:	00c50513          	addi	a0,a0,12 # 7128 <lock_release+0x1020>
    ...
    313c:	03850513          	addi	a0,a0,56 # 7170 <lock_release+0x1068>
    ...
    3158:	08450513          	addi	a0,a0,132 # 71d8 <lock_release+0x10d0>
    ...
    3174:	0e050513          	addi	a0,a0,224 # 7250 <lock_release+0x1148>
    ...
    3190:	12450513          	addi	a0,a0,292 # 72b0 <lock_release+0x11a8>
    ...
    31ac:	16050513          	addi	a0,a0,352 # 7308 <lock_release+0x1200>
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31f8:	14c50513          	addi	a0,a0,332 # 7340 <lock_release+0x1238>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3222:	13250513          	addi	a0,a0,306 # 7350 <lock_release+0x1248>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b2:	09250513          	addi	a0,a0,146 # 7340 <lock_release+0x1238>
  ...
  unlink("diskfulldir");
    ...
    32c6:	07e50513          	addi	a0,a0,126 # 7340 <lock_release+0x1238>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f4:	f8050513          	addi	a0,a0,-128 # 7370 <lock_release+0x1268>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3412:	f9250513          	addi	a0,a0,-110 # 73a0 <lock_release+0x1298>
  ...
  if(chdir("iputdir") < 0){
    ...
    3426:	f7e50513          	addi	a0,a0,-130 # 73a0 <lock_release+0x1298>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343a:	faa50513          	addi	a0,a0,-86 # 73e0 <lock_release+0x12d8>
  ...
  if(chdir("/") < 0){
    ...
    344e:	fc650513          	addi	a0,a0,-58 # 7410 <lock_release+0x1308>
    ...
    346e:	f3e50513          	addi	a0,a0,-194 # 73a8 <lock_release+0x12a0>
    ...
    348a:	f3a50513          	addi	a0,a0,-198 # 73c0 <lock_release+0x12b8>
    ...
    34a6:	f4e50513          	addi	a0,a0,-178 # 73f0 <lock_release+0x12e8>
    ...
    34c2:	f5a50513          	addi	a0,a0,-166 # 7418 <lock_release+0x1310>
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34f6:	eae50513          	addi	a0,a0,-338 # 73a0 <lock_release+0x1298>
    ...
    350a:	e9a50513          	addi	a0,a0,-358 # 73a0 <lock_release+0x1298>
    ...
    351e:	ec650513          	addi	a0,a0,-314 # 73e0 <lock_release+0x12d8>
    ...
    353e:	4a650513          	addi	a0,a0,1190 # 69e0 <lock_release+0x8d8>
    ...
    355a:	e5250513          	addi	a0,a0,-430 # 73a8 <lock_release+0x12a0>
    ...
    3576:	ebe50513          	addi	a0,a0,-322 # 7430 <lock_release+0x1328>
    ...
    3592:	e6250513          	addi	a0,a0,-414 # 73f0 <lock_release+0x12e8>
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d0:	e7c50513          	addi	a0,a0,-388 # 7448 <lock_release+0x1340>
  ...
  if(chdir("dir0") < 0){
    ...
    35e4:	e6850513          	addi	a0,a0,-408 # 7448 <lock_release+0x1340>
  ...
  if(chdir("..") < 0){
    ...
    35f8:	e7450513          	addi	a0,a0,-396 # 7468 <lock_release+0x1360>
  ...
  if(unlink("dir0") < 0){
    ...
    360c:	e4050513          	addi	a0,a0,-448 # 7448 <lock_release+0x1340>
    ...
    362c:	d8050513          	addi	a0,a0,-640 # 73a8 <lock_release+0x12a0>
    ...
    3648:	e0c50513          	addi	a0,a0,-500 # 7450 <lock_release+0x1348>
    ...
    3664:	e1050513          	addi	a0,a0,-496 # 7470 <lock_release+0x1368>
    ...
    3680:	e0c50513          	addi	a0,a0,-500 # 7488 <lock_release+0x1380>
...
0000000000003696 <subdir>:
{
  ...
  unlink("ff");
    ...
    36a8:	f2c50513          	addi	a0,a0,-212 # 75d0 <lock_release+0x14c8>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	532080e7          	jalr	1330(ra) # 5bde <unlink>
  if(mkdir("dd") != 0){
    36b4:	00004517          	auipc	a0,0x4
    36b8:	dec50513          	addi	a0,a0,-532 # 74a0 <lock_release+0x1398>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	df450513          	addi	a0,a0,-524 # 74c0 <lock_release+0x13b8>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	eec58593          	addi	a1,a1,-276 # 75d0 <lock_release+0x14c8>
  ...
  if(unlink("dd") >= 0){
    ...
    3702:	da250513          	addi	a0,a0,-606 # 74a0 <lock_release+0x1398>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3716:	e0650513          	addi	a0,a0,-506 # 7518 <lock_release+0x1410>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	e1650513          	addi	a0,a0,-490 # 7540 <lock_release+0x1438>
  ...
  write(fd, "FF", 2);
    ...
    3746:	e2e58593          	addi	a1,a1,-466 # 7570 <lock_release+0x1468>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	e1a50513          	addi	a0,a0,-486 # 7578 <lock_release+0x1470>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37aa:	e2258593          	addi	a1,a1,-478 # 75c8 <lock_release+0x14c0>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	d9250513          	addi	a0,a0,-622 # 7540 <lock_release+0x1438>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37c6:	d7e50513          	addi	a0,a0,-642 # 7540 <lock_release+0x1438>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37dc:	d6850513          	addi	a0,a0,-664 # 7540 <lock_release+0x1438>
  ...
  if(chdir("dd") != 0){
    ...
    37f0:	cb450513          	addi	a0,a0,-844 # 74a0 <lock_release+0x1398>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3804:	e6050513          	addi	a0,a0,-416 # 7660 <lock_release+0x1558>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3818:	e7c50513          	addi	a0,a0,-388 # 7690 <lock_release+0x1588>
  ...
  if(chdir("./..") != 0){
    ...
    382c:	e9850513          	addi	a0,a0,-360 # 76c0 <lock_release+0x15b8>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	d8a50513          	addi	a0,a0,-630 # 75c8 <lock_release+0x14c0>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    387c:	cc850513          	addi	a0,a0,-824 # 7540 <lock_release+0x1438>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3894:	ec050513          	addi	a0,a0,-320 # 7750 <lock_release+0x1648>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ac:	ed850513          	addi	a0,a0,-296 # 7780 <lock_release+0x1678>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c4:	be050513          	addi	a0,a0,-1056 # 74a0 <lock_release+0x1398>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38da:	bca50513          	addi	a0,a0,-1078 # 74a0 <lock_release+0x1398>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f0:	bb450513          	addi	a0,a0,-1100 # 74a0 <lock_release+0x1398>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3904:	f1058593          	addi	a1,a1,-240 # 7810 <lock_release+0x1708>
    3908:	00004517          	auipc	a0,0x4
    390c:	e4850513          	addi	a0,a0,-440 # 7750 <lock_release+0x1648>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3920:	ef458593          	addi	a1,a1,-268 # 7810 <lock_release+0x1708>
    3924:	00004517          	auipc	a0,0x4
    3928:	e5c50513          	addi	a0,a0,-420 # 7780 <lock_release+0x1678>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    393c:	c9058593          	addi	a1,a1,-880 # 75c8 <lock_release+0x14c0>
    3940:	00004517          	auipc	a0,0x4
    3944:	b8050513          	addi	a0,a0,-1152 # 74c0 <lock_release+0x13b8>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3958:	dfc50513          	addi	a0,a0,-516 # 7750 <lock_release+0x1648>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    396c:	e1850513          	addi	a0,a0,-488 # 7780 <lock_release+0x1678>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3980:	c4c50513          	addi	a0,a0,-948 # 75c8 <lock_release+0x14c0>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3994:	df050513          	addi	a0,a0,-528 # 7780 <lock_release+0x1678>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39a8:	dac50513          	addi	a0,a0,-596 # 7750 <lock_release+0x1648>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39bc:	b0850513          	addi	a0,a0,-1272 # 74c0 <lock_release+0x13b8>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d0:	f9450513          	addi	a0,a0,-108 # 7960 <lock_release+0x1858>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e4:	be850513          	addi	a0,a0,-1048 # 75c8 <lock_release+0x14c0>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39f8:	acc50513          	addi	a0,a0,-1332 # 74c0 <lock_release+0x13b8>
  ...
  if(unlink("dd") == 0){
    ...
    3a0c:	a9850513          	addi	a0,a0,-1384 # 74a0 <lock_release+0x1398>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a20:	fb450513          	addi	a0,a0,-76 # 79d0 <lock_release+0x18c8>
  ...
  if(unlink("dd") < 0){
    ...
    3a34:	a7050513          	addi	a0,a0,-1424 # 74a0 <lock_release+0x1398>
    ...
    3a56:	a5650513          	addi	a0,a0,-1450 # 74a8 <lock_release+0x13a0>
    ...
    3a72:	a5a50513          	addi	a0,a0,-1446 # 74c8 <lock_release+0x13c0>
    ...
    3a8e:	a5e50513          	addi	a0,a0,-1442 # 74e8 <lock_release+0x13e0>
    ...
    3aaa:	a7a50513          	addi	a0,a0,-1414 # 7520 <lock_release+0x1418>
    ...
    3ac6:	a8e50513          	addi	a0,a0,-1394 # 7550 <lock_release+0x1448>
    ...
    3ae2:	aaa50513          	addi	a0,a0,-1366 # 7588 <lock_release+0x1480>
    ...
    3afe:	aae50513          	addi	a0,a0,-1362 # 75a8 <lock_release+0x14a0>
    ...
    3b1a:	ac250513          	addi	a0,a0,-1342 # 75d8 <lock_release+0x14d0>
    ...
    3b36:	ace50513          	addi	a0,a0,-1330 # 7600 <lock_release+0x14f8>
    ...
    3b52:	ad250513          	addi	a0,a0,-1326 # 7620 <lock_release+0x1518>
    ...
    3b6e:	ade50513          	addi	a0,a0,-1314 # 7648 <lock_release+0x1540>
    ...
    3b8a:	aea50513          	addi	a0,a0,-1302 # 7670 <lock_release+0x1568>
    ...
    3ba6:	afe50513          	addi	a0,a0,-1282 # 76a0 <lock_release+0x1598>
    ...
    3bc2:	b0a50513          	addi	a0,a0,-1270 # 76c8 <lock_release+0x15c0>
    ...
    3bde:	b0650513          	addi	a0,a0,-1274 # 76e0 <lock_release+0x15d8>
    ...
    3bfa:	b0a50513          	addi	a0,a0,-1270 # 7700 <lock_release+0x15f8>
    ...
    3c16:	b0e50513          	addi	a0,a0,-1266 # 7720 <lock_release+0x1618>
    ...
    3c32:	b3250513          	addi	a0,a0,-1230 # 7760 <lock_release+0x1658>
    ...
    3c4e:	b4650513          	addi	a0,a0,-1210 # 7790 <lock_release+0x1688>
    ...
    3c6a:	b4a50513          	addi	a0,a0,-1206 # 77b0 <lock_release+0x16a8>
    ...
    3c86:	b4e50513          	addi	a0,a0,-1202 # 77d0 <lock_release+0x16c8>
    ...
    3ca2:	b5250513          	addi	a0,a0,-1198 # 77f0 <lock_release+0x16e8>
    ...
    3cbe:	b6650513          	addi	a0,a0,-1178 # 7820 <lock_release+0x1718>
    ...
    3cda:	b7250513          	addi	a0,a0,-1166 # 7848 <lock_release+0x1740>
    ...
    3cf6:	b7e50513          	addi	a0,a0,-1154 # 7870 <lock_release+0x1768>
    ...
    3d12:	b8a50513          	addi	a0,a0,-1142 # 7898 <lock_release+0x1790>
    ...
    3d2e:	b8e50513          	addi	a0,a0,-1138 # 78b8 <lock_release+0x17b0>
    ...
    3d4a:	b9250513          	addi	a0,a0,-1134 # 78d8 <lock_release+0x17d0>
    ...
    3d66:	b9e50513          	addi	a0,a0,-1122 # 7900 <lock_release+0x17f8>
    ...
    3d82:	ba250513          	addi	a0,a0,-1118 # 7920 <lock_release+0x1818>
    ...
    3d9e:	ba650513          	addi	a0,a0,-1114 # 7940 <lock_release+0x1838>
    ...
    3dba:	bb250513          	addi	a0,a0,-1102 # 7968 <lock_release+0x1860>
    ...
    3dd6:	82e50513          	addi	a0,a0,-2002 # 7600 <lock_release+0x14f8>
    ...
    3df2:	b9a50513          	addi	a0,a0,-1126 # 7988 <lock_release+0x1880>
    ...
    3e0e:	b9e50513          	addi	a0,a0,-1122 # 79a8 <lock_release+0x18a0>
    ...
    3e2a:	bb250513          	addi	a0,a0,-1102 # 79d8 <lock_release+0x18d0>
    ...
    3e46:	bb650513          	addi	a0,a0,-1098 # 79f8 <lock_release+0x18f0>
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e6c:	ba850513          	addi	a0,a0,-1112 # 7a10 <lock_release+0x1908>
  ...
  if(chdir("dots") != 0){
    ...
    3e7e:	b9650513          	addi	a0,a0,-1130 # 7a10 <lock_release+0x1908>
  ...
  if(unlink(".") == 0){
    ...
    3e90:	9b450513          	addi	a0,a0,-1612 # 6840 <lock_release+0x738>
  ...
  if(unlink("..") == 0){
    ...
    3ea2:	5ca50513          	addi	a0,a0,1482 # 7468 <lock_release+0x1360>
  ...
  if(chdir("/") != 0){
    ...
    3eb4:	56050513          	addi	a0,a0,1376 # 7410 <lock_release+0x1308>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ec6:	bb650513          	addi	a0,a0,-1098 # 7a78 <lock_release+0x1970>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ed8:	bcc50513          	addi	a0,a0,-1076 # 7aa0 <lock_release+0x1998>
  ...
  if(unlink("dots") != 0){
    ...
    3eea:	b2a50513          	addi	a0,a0,-1238 # 7a10 <lock_release+0x1908>
    ...
    3f08:	b1450513          	addi	a0,a0,-1260 # 7a18 <lock_release+0x1910>
    ...
    3f24:	b1050513          	addi	a0,a0,-1264 # 7a30 <lock_release+0x1928>
    ...
    3f40:	b0c50513          	addi	a0,a0,-1268 # 7a48 <lock_release+0x1940>
    ...
    3f5c:	b0850513          	addi	a0,a0,-1272 # 7a60 <lock_release+0x1958>
    ...
    3f78:	4a450513          	addi	a0,a0,1188 # 7418 <lock_release+0x1310>
    ...
    3f94:	af050513          	addi	a0,a0,-1296 # 7a80 <lock_release+0x1978>
    ...
    3fb0:	afc50513          	addi	a0,a0,-1284 # 7aa8 <lock_release+0x19a0>
    ...
    3fcc:	b0050513          	addi	a0,a0,-1280 # 7ac8 <lock_release+0x19c0>
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	af450513          	addi	a0,a0,-1292 # 7ae8 <lock_release+0x19e0>
  ...
  if(chdir("dirfile") == 0){
    ...
    4014:	ad850513          	addi	a0,a0,-1320 # 7ae8 <lock_release+0x19e0>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	b0c50513          	addi	a0,a0,-1268 # 7b30 <lock_release+0x1a28>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	af450513          	addi	a0,a0,-1292 # 7b30 <lock_release+0x1a28>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4054:	ae050513          	addi	a0,a0,-1312 # 7b30 <lock_release+0x1a28>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4068:	acc50513          	addi	a0,a0,-1332 # 7b30 <lock_release+0x1a28>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    407c:	ab858593          	addi	a1,a1,-1352 # 7b30 <lock_release+0x1a28>
    4080:	00002517          	auipc	a0,0x2
    4084:	2b050513          	addi	a0,a0,688 # 6330 <lock_release+0x228>
  ...
  if(unlink("dirfile") != 0){
    ...
    4098:	a5450513          	addi	a0,a0,-1452 # 7ae8 <lock_release+0x19e0>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	79650513          	addi	a0,a0,1942 # 6840 <lock_release+0x738>
  ...
  fd = open(".", 0);
    ...
    40c4:	78050513          	addi	a0,a0,1920 # 6840 <lock_release+0x738>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40d8:	0f458593          	addi	a1,a1,244 # 61c8 <lock_release+0xc0>
  ...
  close(fd);
    ...
    4104:	9f050513          	addi	a0,a0,-1552 # 7af0 <lock_release+0x19e8>
    ...
    4120:	9f450513          	addi	a0,a0,-1548 # 7b10 <lock_release+0x1a08>
    ...
    413c:	a0850513          	addi	a0,a0,-1528 # 7b40 <lock_release+0x1a38>
    ...
    4158:	9ec50513          	addi	a0,a0,-1556 # 7b40 <lock_release+0x1a38>
    ...
    4174:	9f850513          	addi	a0,a0,-1544 # 7b68 <lock_release+0x1a60>
    ...
    4190:	a0450513          	addi	a0,a0,-1532 # 7b90 <lock_release+0x1a88>
    ...
    41ac:	a1050513          	addi	a0,a0,-1520 # 7bb8 <lock_release+0x1ab0>
    ...
    41c8:	a1c50513          	addi	a0,a0,-1508 # 7be0 <lock_release+0x1ad8>
    ...
    41e4:	a2050513          	addi	a0,a0,-1504 # 7c00 <lock_release+0x1af8>
    ...
    4200:	a2c50513          	addi	a0,a0,-1492 # 7c28 <lock_release+0x1b20>
...
0000000000004216 <iref>:
{
    ...
    4234:	a10a0a13          	addi	s4,s4,-1520 # 7c40 <lock_release+0x1b38>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	51048493          	addi	s1,s1,1296 # 7748 <lock_release+0x1640>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	0f0a8a93          	addi	s5,s5,240 # 6330 <lock_release+0x228>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	8f098993          	addi	s3,s3,-1808 # 7b38 <lock_release+0x1a30>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	9f450513          	addi	a0,a0,-1548 # 7c48 <lock_release+0x1b40>
    ...
    4274:	9f050513          	addi	a0,a0,-1552 # 7c60 <lock_release+0x1b58>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4308:	16498993          	addi	s3,s3,356 # 7468 <lock_release+0x1360>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	93490913          	addi	s2,s2,-1740 # 7c40 <lock_release+0x1b38>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	0e450513          	addi	a0,a0,228 # 7410 <lock_release+0x1308>
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4360:	91c50513          	addi	a0,a0,-1764 # 7c78 <lock_release+0x1b70>
  ...
  if(pid == 0){
    ...
    4384:	8f850513          	addi	a0,a0,-1800 # 7c78 <lock_release+0x1b70>
    ...
    439a:	90250513          	addi	a0,a0,-1790 # 7c98 <lock_release+0x1b90>
    ...
    43b6:	8ce50513          	addi	a0,a0,-1842 # 7c80 <lock_release+0x1b78>
    ...
    43d2:	61250513          	addi	a0,a0,1554 # 69e0 <lock_release+0x8d8>
  ...
  if(unlink("oidir") != 0){
    ...
    4400:	87c50513          	addi	a0,a0,-1924 # 7c78 <lock_release+0x1b70>
    ...
    4414:	7c050513          	addi	a0,a0,1984 # 6bd0 <lock_release+0xac8>
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4452:	87250513          	addi	a0,a0,-1934 # 7cc0 <lock_release+0x1bb8>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    447e:	84650513          	addi	a0,a0,-1978 # 7cc0 <lock_release+0x1bb8>
  ...
  sleep(10); // one second
    ...
    44b6:	6ee50513          	addi	a0,a0,1774 # 6ba0 <lock_release+0xa98>
    ...
    44d0:	7f448493          	addi	s1,s1,2036 # 7cc0 <lock_release+0x1bb8>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
    ...
    44f8:	7cc50513          	addi	a0,a0,1996 # 7cc0 <lock_release+0x1bb8>
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	46650513          	addi	a0,a0,1126 # 69e0 <lock_release+0x8d8>
    ...
    45a4:	73050513          	addi	a0,a0,1840 # 7cd0 <lock_release+0x1bc8>
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	5c050513          	addi	a0,a0,1472 # 6ba0 <lock_release+0xa98>
  ...
  if(pid2 == 0)
    ...
    4612:	3d250513          	addi	a0,a0,978 # 69e0 <lock_release+0x8d8>
  ...
  if(pid3 == 0){
    ...
    4656:	b7658593          	addi	a1,a1,-1162 # 61c8 <lock_release+0xc0>
    ...
    4680:	36450513          	addi	a0,a0,868 # 69e0 <lock_release+0x8d8>
    ...
    469c:	65850513          	addi	a0,a0,1624 # 7cf0 <lock_release+0x1be8>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	63450513          	addi	a0,a0,1588 # 7d08 <lock_release+0x1c00>
  ...
  printf("kill... ");
    ...
    4704:	62050513          	addi	a0,a0,1568 # 7d20 <lock_release+0x1c18>
  ...
  printf("wait... ");
    ...
    4732:	60250513          	addi	a0,a0,1538 # 7d30 <lock_release+0x1c28>
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	23250513          	addi	a0,a0,562 # 69e0 <lock_release+0x8d8>
    ...
    47ce:	39e50513          	addi	a0,a0,926 # 6b68 <lock_release+0xa60>
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	2a850513          	addi	a0,a0,680 # 6ae8 <lock_release+0x9e0>
    ...
    4878:	95458593          	addi	a1,a1,-1708 # 61c8 <lock_release+0xc0>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	40850513          	addi	a0,a0,1032 # 7d40 <lock_release+0x1c38>
    ...
    4958:	08c50513          	addi	a0,a0,140 # 69e0 <lock_release+0x8d8>
    ...
    49a4:	3c050513          	addi	a0,a0,960 # 7d60 <lock_release+0x1c58>
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a48:	34c50513          	addi	a0,a0,844 # 7d90 <lock_release+0x1c88>
...
0000000000004a68 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afe:	2c650513          	addi	a0,a0,710 # 7dc0 <lock_release+0x1cb8>
    ...
    4b1a:	2d250513          	addi	a0,a0,722 # 7de8 <lock_release+0x1ce0>
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	25650513          	addi	a0,a0,598 # 7db0 <lock_release+0x1ca8>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	26e50513          	addi	a0,a0,622 # 7e08 <lock_release+0x1d00>
  ...
  unlink("sharedfd");
    ...
    4bda:	1da50513          	addi	a0,a0,474 # 7db0 <lock_release+0x1ca8>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	23450513          	addi	a0,a0,564 # 7e30 <lock_release+0x1d28>
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c44:	20878793          	addi	a5,a5,520 # 7e48 <lock_release+0x1d40>
    4c48:	f6f43823          	sd	a5,-144(s0)
    4c4c:	00003797          	auipc	a5,0x3
    4c50:	20478793          	addi	a5,a5,516 # 7e50 <lock_release+0x1d48>
    4c54:	f6f43c23          	sd	a5,-136(s0)
    4c58:	00003797          	auipc	a5,0x3
    4c5c:	20078793          	addi	a5,a5,512 # 7e58 <lock_release+0x1d50>
    4c60:	f8f43023          	sd	a5,-128(s0)
    4c64:	00003797          	auipc	a5,0x3
    4c68:	1fc78793          	addi	a5,a5,508 # 7e60 <lock_release+0x1d58>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cd6:	11650513          	addi	a0,a0,278 # 6de8 <lock_release+0xce0>
    ...
    4d50:	11c50513          	addi	a0,a0,284 # 7e68 <lock_release+0x1d60>
    ...
    4d6a:	11250513          	addi	a0,a0,274 # 7e78 <lock_release+0x1d70>
    ...
    4d90:	10450513          	addi	a0,a0,260 # 7e90 <lock_release+0x1d88>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e18:	08c50513          	addi	a0,a0,140 # 7ea0 <lock_release+0x1d98>
...
0000000000004e4c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e7a:	042b8b93          	addi	s7,s7,66 # 7eb8 <lock_release+0x1db0>
  for(i = 0; i < N; i++){
    ...
    4ebc:	00850513          	addi	a0,a0,8 # 7ec0 <lock_release+0x1db8>
    ...
    4eda:	fe250513          	addi	a0,a0,-30 # 7eb8 <lock_release+0x1db0>
  ...
  fd = open(".", 0);
    ...
    4f12:	93250513          	addi	a0,a0,-1742 # 6840 <lock_release+0x738>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f8a:	f5a50513          	addi	a0,a0,-166 # 7ee0 <lock_release+0x1dd8>
    ...
    4faa:	f5a50513          	addi	a0,a0,-166 # 7f00 <lock_release+0x1df8>
  ...
  for(i = 0; i < N; i++){
    ...
    4fe2:	f4a50513          	addi	a0,a0,-182 # 7f28 <lock_release+0x1e20>
    ...
    4ffe:	9e650513          	addi	a0,a0,-1562 # 69e0 <lock_release+0x8d8>
...
00000000000051a8 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5230:	d3450513          	addi	a0,a0,-716 # 7f60 <lock_release+0x1e58>
  ...
  for(i = 0; ; i++){
    ...
    5294:	ce050513          	addi	a0,a0,-800 # 7f70 <lock_release+0x1e68>
    ...
    52b0:	ce450513          	addi	a0,a0,-796 # 7f90 <lock_release+0x1e88>
    ...
    52cc:	ce850513          	addi	a0,a0,-792 # 7fb0 <lock_release+0x1ea8>
    ...
    52e8:	cec50513          	addi	a0,a0,-788 # 7fd0 <lock_release+0x1ec8>
    ...
    5304:	cf050513          	addi	a0,a0,-784 # 7ff0 <lock_release+0x1ee8>
    ...
    5320:	cec50513          	addi	a0,a0,-788 # 8008 <lock_release+0x1f00>
  ...
  unlink("bigfile.dat");
    ...
    534e:	c1650513          	addi	a0,a0,-1002 # 7f60 <lock_release+0x1e58>
    ...
    5372:	cba50513          	addi	a0,a0,-838 # 8028 <lock_release+0x1f20>
...
0000000000005388 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53a8:	ca450513          	addi	a0,a0,-860 # 8048 <lock_release+0x1f40>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53c8:	c94c8c93          	addi	s9,s9,-876 # 8058 <lock_release+0x1f50>
    name[0] = 'f';
    ...
    5438:	c3450513          	addi	a0,a0,-972 # 8068 <lock_release+0x1f60>
  ...
  printf("fsfull test finished\n");
    ...
    54ae:	bde50513          	addi	a0,a0,-1058 # 8088 <lock_release+0x1f80>
    ...
    5504:	b7850513          	addi	a0,a0,-1160 # 8078 <lock_release+0x1f70>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5536:	b6e50513          	addi	a0,a0,-1170 # 80a0 <lock_release+0x1f98>
  ...
  if(pid == 0) {
    ...
    5566:	b6650513          	addi	a0,a0,-1178 # 80c8 <lock_release+0x1fc0>
    ...
    558a:	b2a50513          	addi	a0,a0,-1238 # 80b0 <lock_release+0x1fa8>
    ...
    55b2:	b2250513          	addi	a0,a0,-1246 # 80d0 <lock_release+0x1fc8>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5602:	ada50513          	addi	a0,a0,-1318 # 80d8 <lock_release+0x1fd0>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    565c:	b7098993          	addi	s3,s3,-1168 # 61c8 <lock_release+0xc0>
      uint64 a = (uint64) sbrk(4096);
    ...
    568e:	aa650513          	addi	a0,a0,-1370 # 8130 <lock_release+0x2028>
    ...
    56a8:	a4c50513          	addi	a0,a0,-1460 # 80f0 <lock_release+0x1fe8>
    ...
    56c2:	a5250513          	addi	a0,a0,-1454 # 8110 <lock_release+0x2008>
  ...
  while(1){
    ...
    5710:	a4450513          	addi	a0,a0,-1468 # 8150 <lock_release+0x2048>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5772:	a02b8b93          	addi	s7,s7,-1534 # 8170 <lock_release+0x2068>
    int free0 = countfree();
    int free1 = 0;
    ...
    578c:	a00d0d13          	addi	s10,s10,-1536 # 8188 <lock_release+0x2080>
          return 1;
        }
      }
    }
    ...
    5794:	a18c8c93          	addi	s9,s9,-1512 # 81a8 <lock_release+0x20a0>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    586c:	97058593          	addi	a1,a1,-1680 # 81d8 <lock_release+0x20d0>
  ...
  char *justone = 0;
    ...
    588a:	95a58593          	addi	a1,a1,-1702 # 81e0 <lock_release+0x20d8>
    ...
    58a0:	99458593          	addi	a1,a1,-1644 # 8230 <lock_release+0x2128>
  ...
  int continuous = 0;
    ...
    58cc:	92050513          	addi	a0,a0,-1760 # 81e8 <lock_release+0x20e0>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    58f2:	92a50513          	addi	a0,a0,-1750 # 8218 <lock_release+0x2110>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5c7e:	97e50513          	addi	a0,a0,-1666 # 85f8 <digits>
    5c82:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    5d7e:	00003717          	auipc	a4,0x3
    5d82:	82270713          	addi	a4,a4,-2014 # 85a0 <lock_release+0x2498>
  ...
  putc(fd, 'x');
    ...
    5e0c:	7f0b8b93          	addi	s7,s7,2032 # 85f8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5e60:	73c90913          	addi	s2,s2,1852 # 8598 <lock_release+0x2490>
        while(*s != 0){
...
000000000000609c <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
    609c:	1101                	addi	sp,sp,-32
    609e:	ec06                	sd	ra,24(sp)
    60a0:	e822                	sd	s0,16(sp)
    60a2:	e426                	sd	s1,8(sp)
    60a4:	e04a                	sd	s2,0(sp)
    60a6:	1000                	addi	s0,sp,32
    60a8:	84aa                	mv	s1,a0
    60aa:	892e                	mv	s2,a1
  ...
  return 0;
    ...
    60c0:	4501                	li	a0,0
    60c2:	60e2                	ld	ra,24(sp)
    60c4:	6442                	ld	s0,16(sp)
    60c6:	64a2                	ld	s1,8(sp)
    60c8:	6902                	ld	s2,0(sp)
    60ca:	6105                	addi	sp,sp,32
    60cc:	8082                	ret
    (*start_routine)(arg);
    60ce:	854a                	mv	a0,s2
    60d0:	9482                	jalr	s1
    ...
    60d8:	aba080e7          	jalr	-1350(ra) # 5b8e <exit>

00000000000060dc <lock_init>:

// Initialize lock
void lock_init(struct lock_t* lock) {
    60dc:	1141                	addi	sp,sp,-16
    60de:	e422                	sd	s0,8(sp)
    60e0:	0800                	addi	s0,sp,16
  lock->locked = 0;
    60e2:	00052023          	sw	zero,0(a0) # 1000 <linktest+0x10c>
}
    60e6:	6422                	ld	s0,8(sp)
    60e8:	0141                	addi	sp,sp,16
    60ea:	8082                	ret

00000000000060ec <lock_acquire>:

void lock_acquire(struct lock_t* lock) {
    60ec:	1141                	addi	sp,sp,-16
    60ee:	e422                	sd	s0,8(sp)
    60f0:	0800                	addi	s0,sp,16
   ...
   */
    ...
    60f2:	4705                	li	a4,1
    60f4:	87ba                	mv	a5,a4
    60f6:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
    60fa:	2781                	sext.w	a5,a5
    60fc:	ffe5                	bnez	a5,60f4 <lock_acquire+0x8>
    __sync_synchronize();
    60fe:	0ff0000f          	fence
}
    6102:	6422                	ld	s0,8(sp)
    6104:	0141                	addi	sp,sp,16
    6106:	8082                	ret

0000000000006108 <lock_release>:

void lock_release(struct lock_t* lock) {
    6108:	1141                	addi	sp,sp,-16
    610a:	e422                	sd	s0,8(sp)
    610c:	0800                	addi	s0,sp,16
    // On RISC-V, the following emits a fence instruction.
    __sync_synchronize();
    610e:	0ff0000f          	fence
    ...
    6112:	0f50000f          	fence	iorw,ow
    6116:	0805202f          	amoswap.w	zero,zero,(a0)
}
    611a:	6422                	ld	s0,8(sp)
    611c:	0141                	addi	sp,sp,16
    611e:	8082                	ret
