...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	37e58593          	addi	a1,a1,894 # 1390 <lock_release+0x20>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	33858593          	addi	a1,a1,824 # 1398 <lock_release+0x28>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	30650513          	addi	a0,a0,774 # 13a0 <lock_release+0x30>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	3da70713          	addi	a4,a4,986 # 14a0 <lock_release+0x130>
    ...
    panic("runcmd");
      ...
      e4:	2c850513          	addi	a0,a0,712 # 13a8 <lock_release+0x38>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	2ae58593          	addi	a1,a1,686 # 13b0 <lock_release+0x40>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	27258593          	addi	a1,a1,626 # 13c0 <lock_release+0x50>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	1ec50513          	addi	a0,a0,492 # 13d0 <lock_release+0x60>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	e42b8b93          	addi	s7,s7,-446 # 13f8 <lock_release+0x88>
  ...
  while(peek(ps, es, "<>")){
     ...
     5cc:	e1050513          	addi	a0,a0,-496 # 13d8 <lock_release+0x68>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6b4:	d5060613          	addi	a2,a2,-688 # 1400 <lock_release+0x90>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6e4:	d40b0b13          	addi	s6,s6,-704 # 1420 <lock_release+0xb0>
  ...
  return ret;
     ...
     71e:	cee50513          	addi	a0,a0,-786 # 1408 <lock_release+0x98>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     780:	c9450513          	addi	a0,a0,-876 # 1410 <lock_release+0xa0>
...
000000000000079a <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ba:	c7260613          	addi	a2,a2,-910 # 1428 <lock_release+0xb8>
     7be:	85ce                	mv	a1,s3
     7c0:	854a                	mv	a0,s2
...
0000000000000808 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     82a:	c0aa0a13          	addi	s4,s4,-1014 # 1430 <lock_release+0xc0>
  ...
  if(peek(ps, es, ";")){
     ...
     860:	bdc60613          	addi	a2,a2,-1060 # 1438 <lock_release+0xc8>
     864:	85ce                	mv	a1,s3
     866:	854a                	mv	a0,s2
...
00000000000008b0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c6:	b3e60613          	addi	a2,a2,-1218 # 1400 <lock_release+0x90>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f6:	b5e60613          	addi	a2,a2,-1186 # 1450 <lock_release+0xe0>
     8fa:	85ca                	mv	a1,s2
     8fc:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     938:	b0c50513          	addi	a0,a0,-1268 # 1440 <lock_release+0xd0>
     93c:	fffff097          	auipc	ra,0xfffff
     940:	71a080e7          	jalr	1818(ra) # 56 <panic>
    panic("syntax - missing )");
     944:	00001517          	auipc	a0,0x1
     948:	b1450513          	addi	a0,a0,-1260 # 1458 <lock_release+0xe8>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     974:	b4870713          	addi	a4,a4,-1208 # 14b8 <lock_release+0x148>
...
00000000000009ec <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a20:	a5460613          	addi	a2,a2,-1452 # 1470 <lock_release+0x100>
     a24:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a56:	a2658593          	addi	a1,a1,-1498 # 1478 <lock_release+0x108>
     a5a:	4509                	li	a0,2
     a5c:	00000097          	auipc	ra,0x0
     a60:	6dc080e7          	jalr	1756(ra) # 1138 <fprintf>
    panic("syntax");
     a64:	00001517          	auipc	a0,0x1
     a68:	9a450513          	addi	a0,a0,-1628 # 1408 <lock_release+0x98>
...
0000000000000a74 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a88:	a0448493          	addi	s1,s1,-1532 # 1488 <lock_release+0x118>
     a8c:	4589                	li	a1,2
     a8e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b3e:	95658593          	addi	a1,a1,-1706 # 1490 <lock_release+0x120>
     b42:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ee6:	64e50513          	addi	a0,a0,1614 # 1530 <digits>
     eea:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fea:	4f270713          	addi	a4,a4,1266 # 14d8 <lock_release+0x168>
  ...
  putc(fd, 'x');
    ...
    1074:	4c0b8b93          	addi	s7,s7,1216 # 1530 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10c8:	40c90913          	addi	s2,s2,1036 # 14d0 <lock_release+0x160>
        while(*s != 0){
...
int thread_create(void *(start_routine)(void*), void *arg) {
  ...
  int tid = clone(st_ptr);
    ...
    1322:	b78080e7          	jalr	-1160(ra) # e96 <clone>

  // For a child process, call the start_routine function with arg, i.e. tid = 0.
  if (tid == 0) {
    1326:	c901                	beqz	a0,1336 <thread_create+0x32>
    exit(0);
  }
  ...
  return 0;
    ...
    132c:	6442                	ld	s0,16(sp)
    132e:	64a2                	ld	s1,8(sp)
    1330:	6902                	ld	s2,0(sp)
    ...
    1340:	aba080e7          	jalr	-1350(ra) # df6 <exit>

0000000000001344 <lock_init>:

// Initialize lock
void lock_init(struct lock_t* lock) {
    1344:	1141                	addi	sp,sp,-16
    1346:	e422                	sd	s0,8(sp)
    1348:	0800                	addi	s0,sp,16
  lock->locked = 0;
    134a:	00052023          	sw	zero,0(a0) # 1000 <vprintf+0x94>
}
    134e:	6422                	ld	s0,8(sp)
    1350:	0141                	addi	sp,sp,16
    1352:	8082                	ret

0000000000001354 <lock_acquire>:

void lock_acquire(struct lock_t* lock) {
    1354:	1141                	addi	sp,sp,-16
    1356:	e422                	sd	s0,8(sp)
   ...
   */
    ...
    135a:	4705                	li	a4,1
    135c:	87ba                	mv	a5,a4
    135e:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
    1362:	2781                	sext.w	a5,a5
    1364:	ffe5                	bnez	a5,135c <lock_acquire+0x8>
    __sync_synchronize();
    1366:	0ff0000f          	fence
}
...
void lock_release(struct lock_t* lock) {
    ...
    137a:	0f50000f          	fence	iorw,ow
    137e:	0805202f          	amoswap.w	zero,zero,(a0)
}
    1382:	6422                	ld	s0,8(sp)
