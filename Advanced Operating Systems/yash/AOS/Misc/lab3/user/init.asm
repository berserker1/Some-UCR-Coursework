...
main(void)
{
  ...
  12:	90250513          	addi	a0,a0,-1790 # 910 <lock_release+0x18>
  ...
  3a:	8e290913          	addi	s2,s2,-1822 # 918 <lock_release+0x20>
  3e:	854a                	mv	a0,s2
  ...
  6e:	8fe50513          	addi	a0,a0,-1794 # 968 <lock_release+0x70>
  ...
  8c:	88850513          	addi	a0,a0,-1912 # 910 <lock_release+0x18>
  90:	00000097          	auipc	ra,0x0
  94:	336080e7          	jalr	822(ra) # 3c6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	87650513          	addi	a0,a0,-1930 # 910 <lock_release+0x18>
  a2:	00000097          	auipc	ra,0x0
  a6:	31c080e7          	jalr	796(ra) # 3be <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	88450513          	addi	a0,a0,-1916 # 930 <lock_release+0x38>
  ...
  d2:	87a50513          	addi	a0,a0,-1926 # 948 <lock_release+0x50>
  d6:	00000097          	auipc	ra,0x0
  da:	2e0080e7          	jalr	736(ra) # 3b6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	87250513          	addi	a0,a0,-1934 # 950 <lock_release+0x58>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 572:	42270713          	addi	a4,a4,1058 # 990 <lock_release+0x98>
 ...
 5fc:	3f0b8b93          	addi	s7,s7,1008 # 9e8 <digits>
 ...
 650:	33c90913          	addi	s2,s2,828 # 988 <lock_release+0x90>
        while(*s != 0){
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 8a2:	f08080e7          	jalr	-248(ra) # 7a6 <malloc>
  int tid = clone(st_ptr);
 8a6:	00000097          	auipc	ra,0x0
 8aa:	b78080e7          	jalr	-1160(ra) # 41e <clone>

  // For a child process, call the start_routine function with arg, i.e. tid = 0.
  if (tid == 0) {
 8ae:	c901                	beqz	a0,8be <thread_create+0x32>
    exit(0);
  }
 ...
 8c8:	aba080e7          	jalr	-1350(ra) # 37e <exit>

00000000000008cc <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 8d0:	0800                	addi	s0,sp,16
  lock->locked = 0;
 8d2:	00052023          	sw	zero,0(a0) # 1000 <argv>
}
 8d6:	6422                	ld	s0,8(sp)
 8d8:	0141                	addi	sp,sp,16
 8da:	8082                	ret

00000000000008dc <lock_acquire>:
...
void lock_acquire(struct lock_t* lock) {
 ...
 8e2:	4705                	li	a4,1
 8e4:	87ba                	mv	a5,a4
 8e6:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 8ea:	2781                	sext.w	a5,a5
 8ec:	ffe5                	bnez	a5,8e4 <lock_acquire+0x8>
    __sync_synchronize();
 8ee:	0ff0000f          	fence
}
 8f2:	6422                	ld	s0,8(sp)
...
void lock_release(struct lock_t* lock) {
 ...
 902:	0f50000f          	fence	iorw,ow
 906:	0805202f          	amoswap.w	zero,zero,(a0)
}
 90a:	6422                	ld	s0,8(sp)
