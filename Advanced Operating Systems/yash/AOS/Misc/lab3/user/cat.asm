...
cat(int fd)
{
  ...
  44:	90058593          	addi	a1,a1,-1792 # 940 <lock_release+0x24>
  48:	4509                	li	a0,2
  ...
  72:	8ea58593          	addi	a1,a1,-1814 # 958 <lock_release+0x3c>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 104:	87058593          	addi	a1,a1,-1936 # 970 <lock_release+0x54>
 108:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 492:	55a50513          	addi	a0,a0,1370 # 9e8 <digits>
 496:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 596:	3fe70713          	addi	a4,a4,1022 # 990 <lock_release+0x74>
 ...
 620:	3ccb8b93          	addi	s7,s7,972 # 9e8 <digits>
 ...
 674:	31890913          	addi	s2,s2,792 # 988 <lock_release+0x6c>
        while(*s != 0){
...
00000000000008b0 <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 8c6:	f08080e7          	jalr	-248(ra) # 7ca <malloc>
  int tid = clone(st_ptr);
 8ca:	00000097          	auipc	ra,0x0
 8ce:	b78080e7          	jalr	-1160(ra) # 442 <clone>

  // For a child process, call the start_routine function with arg, i.e. tid = 0.
  if (tid == 0) {
 8d2:	c901                	beqz	a0,8e2 <thread_create+0x32>
    exit(0);
  }
 ...
 8ec:	aba080e7          	jalr	-1350(ra) # 3a2 <exit>

00000000000008f0 <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 8f4:	0800                	addi	s0,sp,16
  lock->locked = 0;
 8f6:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 8fa:	6422                	ld	s0,8(sp)
 8fc:	0141                	addi	sp,sp,16
 8fe:	8082                	ret

0000000000000900 <lock_acquire>:
...
void lock_acquire(struct lock_t* lock) {
 ...
 906:	4705                	li	a4,1
 908:	87ba                	mv	a5,a4
 90a:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 90e:	2781                	sext.w	a5,a5
 910:	ffe5                	bnez	a5,908 <lock_acquire+0x8>
    __sync_synchronize();
 912:	0ff0000f          	fence
}
 916:	6422                	ld	s0,8(sp)
...
void lock_release(struct lock_t* lock) {
 ...
 926:	0f50000f          	fence	iorw,ow
 92a:	0805202f          	amoswap.w	zero,zero,(a0)
}
 92e:	6422                	ld	s0,8(sp)
