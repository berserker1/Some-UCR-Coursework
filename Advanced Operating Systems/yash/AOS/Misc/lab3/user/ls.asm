...
ls(char *path)
{
 ...
 128:	9fc50513          	addi	a0,a0,-1540 # b20 <lock_release+0x4e>
 ...
 166:	98e58593          	addi	a1,a1,-1650 # af0 <lock_release+0x1e>
 16a:	4509                	li	a0,2
 ...
 17c:	99058593          	addi	a1,a1,-1648 # b08 <lock_release+0x36>
 180:	4509                	li	a0,2
 ...
 1ae:	98650513          	addi	a0,a0,-1658 # b30 <lock_release+0x5e>
 ...
 1f2:	95aa0a13          	addi	s4,s4,-1702 # b48 <lock_release+0x76>
        printf("ls: cannot stat %s\n", buf);
 1f6:	00001a97          	auipc	s5,0x1
 1fa:	912a8a93          	addi	s5,s5,-1774 # b08 <lock_release+0x36>
...
main(int argc, char *argv[])
{
 ...
 2bc:	8a050513          	addi	a0,a0,-1888 # b58 <lock_release+0x86>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 648:	57c50513          	addi	a0,a0,1404 # bc0 <digits>
 64c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 74c:	42070713          	addi	a4,a4,1056 # b68 <lock_release+0x96>
 ...
 7d6:	3eeb8b93          	addi	s7,s7,1006 # bc0 <digits>
 ...
 82a:	33a90913          	addi	s2,s2,826 # b60 <lock_release+0x8e>
        while(*s != 0){
...
0000000000000a66 <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 aa2:	aba080e7          	jalr	-1350(ra) # 558 <exit>

0000000000000aa6 <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 aaa:	0800                	addi	s0,sp,16
  lock->locked = 0;
 aac:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 ab0:	6422                	ld	s0,8(sp)
 ab2:	0141                	addi	sp,sp,16
 ab4:	8082                	ret

0000000000000ab6 <lock_acquire>:
...
void lock_acquire(struct lock_t* lock) {
 ...
 abc:	4705                	li	a4,1
 abe:	87ba                	mv	a5,a4
 ac0:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 ac4:	2781                	sext.w	a5,a5
 ac6:	ffe5                	bnez	a5,abe <lock_acquire+0x8>
    __sync_synchronize();
 ac8:	0ff0000f          	fence
}
 acc:	6422                	ld	s0,8(sp)
...
void lock_release(struct lock_t* lock) {
 ...
 adc:	0f50000f          	fence	iorw,ow
 ae0:	0805202f          	amoswap.w	zero,zero,(a0)
}
 ae4:	6422                	ld	s0,8(sp)
