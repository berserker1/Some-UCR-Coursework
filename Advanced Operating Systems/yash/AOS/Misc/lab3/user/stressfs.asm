...
main(int argc, char *argv[])
{
  ...
  1a:	94a78793          	addi	a5,a5,-1718 # 960 <lock_release+0x54>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	90450513          	addi	a0,a0,-1788 # 930 <lock_release+0x24>
  ...
  6c:	8e050513          	addi	a0,a0,-1824 # 948 <lock_release+0x3c>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	8a250513          	addi	a0,a0,-1886 # 958 <lock_release+0x4c>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 586:	3f670713          	addi	a4,a4,1014 # 978 <lock_release+0x6c>
 ...
 610:	3c4b8b93          	addi	s7,s7,964 # 9d0 <digits>
 ...
 664:	31090913          	addi	s2,s2,784 # 970 <lock_release+0x64>
        while(*s != 0){
...
00000000000008a0 <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 8b6:	f08080e7          	jalr	-248(ra) # 7ba <malloc>
  int tid = clone(st_ptr);
 8ba:	00000097          	auipc	ra,0x0
 8be:	b78080e7          	jalr	-1160(ra) # 432 <clone>

  // For a child process, call the start_routine function with arg, i.e. tid = 0.
  if (tid == 0) {
 8c2:	c901                	beqz	a0,8d2 <thread_create+0x32>
    exit(0);
  }
 ...
 8dc:	aba080e7          	jalr	-1350(ra) # 392 <exit>

00000000000008e0 <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 8e4:	0800                	addi	s0,sp,16
  lock->locked = 0;
 8e6:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 8ea:	6422                	ld	s0,8(sp)
 8ec:	0141                	addi	sp,sp,16
 8ee:	8082                	ret

00000000000008f0 <lock_acquire>:
...
void lock_acquire(struct lock_t* lock) {
 ...
 8f6:	4705                	li	a4,1
 8f8:	87ba                	mv	a5,a4
 8fa:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 8fe:	2781                	sext.w	a5,a5
 900:	ffe5                	bnez	a5,8f8 <lock_acquire+0x8>
    __sync_synchronize();
 902:	0ff0000f          	fence
}
 906:	6422                	ld	s0,8(sp)
...
void lock_release(struct lock_t* lock) {
 ...
 916:	0f50000f          	fence	iorw,ow
 91a:	0805202f          	amoswap.w	zero,zero,(a0)
}
 91e:	6422                	ld	s0,8(sp)
