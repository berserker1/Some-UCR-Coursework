...
ls(char *path)
{
 ...
 12c:	a1850513          	addi	a0,a0,-1512 # b40 <lock_release+0x4a>
 ...
 16a:	9aa58593          	addi	a1,a1,-1622 # b10 <lock_release+0x1a>
 16e:	4509                	li	a0,2
 ...
 180:	9ac58593          	addi	a1,a1,-1620 # b28 <lock_release+0x32>
 184:	4509                	li	a0,2
 ...
 1b2:	9a250513          	addi	a0,a0,-1630 # b50 <lock_release+0x5a>
 ...
 1f8:	974a0a13          	addi	s4,s4,-1676 # b68 <lock_release+0x72>
        printf("ls: cannot stat %s\n", buf);
 1fc:	00001a97          	auipc	s5,0x1
 200:	92ca8a93          	addi	s5,s5,-1748 # b28 <lock_release+0x32>
...
main(int argc, char *argv[])
{
 ...
 2c2:	8ba50513          	addi	a0,a0,-1862 # b78 <lock_release+0x82>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 658:	53450513          	addi	a0,a0,1332 # b88 <digits>
 65c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 724:	468b8b93          	addi	s7,s7,1128 # b88 <digits>
 ...
 864:	32090913          	addi	s2,s2,800 # b80 <lock_release+0x8a>
        while(*s != 0){
...
0000000000000a8a <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 ac6:	aa6080e7          	jalr	-1370(ra) # 568 <exit>

0000000000000aca <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 ace:	0800                	addi	s0,sp,16
  lock->locked = 0;
 ad0:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 ad4:	6422                	ld	s0,8(sp)
 ad6:	0141                	addi	sp,sp,16
 ad8:	8082                	ret

0000000000000ada <lock_acquire>:
...
//    __sync_synchronize();
 ...
 ae0:	4705                	li	a4,1
 ae2:	87ba                	mv	a5,a4
 ae4:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 ae8:	2781                	sext.w	a5,a5
 aea:	ffe5                	bnez	a5,ae2 <lock_acquire+0x8>
    __sync_synchronize();
 aec:	0ff0000f          	fence
}
 af0:	6422                	ld	s0,8(sp)
...
//    __sync_lock_release(&lock->locked, 0);
    __sync_lock_release(&lock->locked, 0);
 b00:	0f50000f          	fence	iorw,ow
 b04:	0805202f          	amoswap.w	zero,zero,(a0)
//
}
 b08:	6422                	ld	s0,8(sp)
