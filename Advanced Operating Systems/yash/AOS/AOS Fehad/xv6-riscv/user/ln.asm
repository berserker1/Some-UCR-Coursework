...
main(int argc, char *argv[])
{
  ...
  14:	89058593          	addi	a1,a1,-1904 # 8a0 <lock_release+0x22>
  18:	4509                	li	a0,2
  ...
  50:	86c58593          	addi	a1,a1,-1940 # 8b8 <lock_release+0x3a>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e0:	4fc50513          	addi	a0,a0,1276 # 8d8 <digits>
 3e4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ac:	430b8b93          	addi	s7,s7,1072 # 8d8 <digits>
 ...
 5ec:	2e890913          	addi	s2,s2,744 # 8d0 <lock_release+0x52>
        while(*s != 0){
...
0000000000000812 <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 828:	f0a080e7          	jalr	-246(ra) # 72e <malloc>
  int tid = clone(st_ptr);
 82c:	00000097          	auipc	ra,0x0
 830:	b64080e7          	jalr	-1180(ra) # 390 <clone>

  // For a child process, call the start_routine function with arg, i.e. tid = 0.
  if (tid == 0) {
 834:	c901                	beqz	a0,844 <thread_create+0x32>
    exit(0);
  }
 ...
 84e:	aa6080e7          	jalr	-1370(ra) # 2f0 <exit>

0000000000000852 <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 856:	0800                	addi	s0,sp,16
  lock->locked = 0;
 858:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 85c:	6422                	ld	s0,8(sp)
 85e:	0141                	addi	sp,sp,16
 860:	8082                	ret

0000000000000862 <lock_acquire>:
...
//    __sync_synchronize();
 ...
 868:	4705                	li	a4,1
 86a:	87ba                	mv	a5,a4
 86c:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 870:	2781                	sext.w	a5,a5
 872:	ffe5                	bnez	a5,86a <lock_acquire+0x8>
    __sync_synchronize();
 874:	0ff0000f          	fence
}
 878:	6422                	ld	s0,8(sp)
...
//    __sync_lock_release(&lock->locked, 0);
    __sync_lock_release(&lock->locked, 0);
 888:	0f50000f          	fence	iorw,ow
 88c:	0805202f          	amoswap.w	zero,zero,(a0)
//
}
 890:	6422                	ld	s0,8(sp)
