...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	16250513          	addi	a0,a0,354 # 61a0 <lock_release+0x42>
      ...
      74:	8082                	ret
{
      ...
      84:	14050513          	addi	a0,a0,320 # 61c0 <lock_release+0x62>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	13050513          	addi	a0,a0,304 # 61d8 <lock_release+0x7a>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	13250513          	addi	a0,a0,306 # 61f8 <lock_release+0x9a>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	0fa50513          	addi	a0,a0,250 # 61e0 <lock_release+0x82>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	10650513          	addi	a0,a0,262 # 6208 <lock_release+0xaa>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	10450513          	addi	a0,a0,260 # 6230 <lock_release+0xd2>
     134:	00006097          	auipc	ra,0x6
     138:	aec080e7          	jalr	-1300(ra) # 5c20 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	0f050513          	addi	a0,a0,240 # 6230 <lock_release+0xd2>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	0ec58593          	addi	a1,a1,236 # 6240 <lock_release+0xe2>
     15c:	00006097          	auipc	ra,0x6
     160:	a94080e7          	jalr	-1388(ra) # 5bf0 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	0c850513          	addi	a0,a0,200 # 6230 <lock_release+0xd2>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	0cc58593          	addi	a1,a1,204 # 6248 <lock_release+0xea>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	09c50513          	addi	a0,a0,156 # 6230 <lock_release+0xd2>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	08650513          	addi	a0,a0,134 # 6250 <lock_release+0xf2>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	ffc50513          	addi	a0,a0,-4 # 6278 <lock_release+0x11a>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	fe8a8a93          	addi	s5,s5,-24 # 6278 <lock_release+0x11a>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f7650513          	addi	a0,a0,-138 # 6288 <lock_release+0x12a>
     ...
     33a:	f7250513          	addi	a0,a0,-142 # 62a8 <lock_release+0x14a>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     364:	f6050513          	addi	a0,a0,-160 # 62c0 <lock_release+0x162>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     378:	f4c98993          	addi	s3,s3,-180 # 62c0 <lock_release+0x162>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c4:	f0050513          	addi	a0,a0,-256 # 62c0 <lock_release+0x162>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3dc:	e7058593          	addi	a1,a1,-400 # 6248 <lock_release+0xea>
    ...
    printf("write failed\n");
     ...
     3f2:	ef250513          	addi	a0,a0,-270 # 62e0 <lock_release+0x182>
    ...
    exit(1);
     ...
     40c:	ec050513          	addi	a0,a0,-320 # 62c8 <lock_release+0x16a>
    ...
    printf("open junk failed\n");
     ...
     426:	ea650513          	addi	a0,a0,-346 # 62c8 <lock_release+0x16a>
  ...
  unlink("junk");
     ...
     44a:	e7a50513          	addi	a0,a0,-390 # 62c0 <lock_release+0x162>
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     556:	d9ea0a13          	addi	s4,s4,-610 # 62f0 <lock_release+0x192>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     602:	cfa50513          	addi	a0,a0,-774 # 62f8 <lock_release+0x19a>
     ...
     620:	cf450513          	addi	a0,a0,-780 # 6310 <lock_release+0x1b2>
     ...
     63e:	d0650513          	addi	a0,a0,-762 # 6340 <lock_release+0x1e2>
     ...
     658:	d1c50513          	addi	a0,a0,-740 # 6370 <lock_release+0x212>
     ...
     676:	d0e50513          	addi	a0,a0,-754 # 6380 <lock_release+0x222>
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b4:	d00a0a13          	addi	s4,s4,-768 # 63b0 <lock_release+0x252>
    n = write(fds[1], "x", 1);
     6b8:	00006a97          	auipc	s5,0x6
     6bc:	b90a8a93          	addi	s5,s5,-1136 # 6248 <lock_release+0xea>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     762:	c5a50513          	addi	a0,a0,-934 # 63b8 <lock_release+0x25a>
     ...
     780:	c5450513          	addi	a0,a0,-940 # 63d0 <lock_release+0x272>
     ...
     79a:	bda50513          	addi	a0,a0,-1062 # 6370 <lock_release+0x212>
     ...
     7b4:	c5050513          	addi	a0,a0,-944 # 6400 <lock_release+0x2a2>
     ...
     7d2:	c4a50513          	addi	a0,a0,-950 # 6418 <lock_release+0x2ba>
...
00000000000007e8 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     828:	a1c58593          	addi	a1,a1,-1508 # 6240 <lock_release+0xe2>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     844:	9f050513          	addi	a0,a0,-1552 # 6230 <lock_release+0xd2>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     870:	9c450513          	addi	a0,a0,-1596 # 6230 <lock_release+0xd2>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     884:	9b050513          	addi	a0,a0,-1616 # 6230 <lock_release+0xd2>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c2:	bea58593          	addi	a1,a1,-1046 # 64a8 <lock_release+0x34a>
     8c6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     904:	93050513          	addi	a0,a0,-1744 # 6230 <lock_release+0xd2>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     948:	b0450513          	addi	a0,a0,-1276 # 6448 <lock_release+0x2ea>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     964:	b0850513          	addi	a0,a0,-1272 # 6468 <lock_release+0x30a>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     978:	b0450513          	addi	a0,a0,-1276 # 6478 <lock_release+0x31a>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     994:	b0850513          	addi	a0,a0,-1272 # 6498 <lock_release+0x33a>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a8:	ad450513          	addi	a0,a0,-1324 # 6478 <lock_release+0x31a>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c6:	aee50513          	addi	a0,a0,-1298 # 64b0 <lock_release+0x352>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e4:	af050513          	addi	a0,a0,-1296 # 64d0 <lock_release+0x372>
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a18:	adc50513          	addi	a0,a0,-1316 # 64f0 <lock_release+0x392>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a30:	aec98993          	addi	s3,s3,-1300 # 6518 <lock_release+0x3ba>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a34:	00006a97          	auipc	s5,0x6
     a38:	b1ca8a93          	addi	s5,s5,-1252 # 6550 <lock_release+0x3f2>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7e:	a7650513          	addi	a0,a0,-1418 # 64f0 <lock_release+0x392>
  ...
  if(unlink("small") < 0){
     ...
     aba:	a3a50513          	addi	a0,a0,-1478 # 64f0 <lock_release+0x392>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae4:	a1850513          	addi	a0,a0,-1512 # 64f8 <lock_release+0x39a>
    ...
    exit(1);
     ...
     b02:	a2a50513          	addi	a0,a0,-1494 # 6528 <lock_release+0x3ca>
     ...
     b20:	a4450513          	addi	a0,a0,-1468 # 6560 <lock_release+0x402>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3c:	a5050513          	addi	a0,a0,-1456 # 6588 <lock_release+0x42a>
    ...
    printf("%s: read failed\n", s);
     ...
     b58:	a5450513          	addi	a0,a0,-1452 # 65a8 <lock_release+0x44a>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b74:	a5050513          	addi	a0,a0,-1456 # 65c0 <lock_release+0x462>
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba6:	a3e50513          	addi	a0,a0,-1474 # 65e0 <lock_release+0x482>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf8:	9ec50513          	addi	a0,a0,-1556 # 65e0 <lock_release+0x482>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	9ac50513          	addi	a0,a0,-1620 # 65e8 <lock_release+0x48a>
    ...
    exit(1);
     ...
     c5e:	9ae50513          	addi	a0,a0,-1618 # 6608 <lock_release+0x4aa>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c7a:	9ba50513          	addi	a0,a0,-1606 # 6630 <lock_release+0x4d2>
  ...
  if(unlink("big") < 0){
     ...
     ca6:	93e50513          	addi	a0,a0,-1730 # 65e0 <lock_release+0x482>
     ...
     cd2:	98250513          	addi	a0,a0,-1662 # 6650 <lock_release+0x4f2>
     ...
     cf0:	98c50513          	addi	a0,a0,-1652 # 6678 <lock_release+0x51a>
     ...
     d0e:	98650513          	addi	a0,a0,-1658 # 6690 <lock_release+0x532>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d2a:	99250513          	addi	a0,a0,-1646 # 66b8 <lock_release+0x55a>
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	97c50513          	addi	a0,a0,-1668 # 66d0 <lock_release+0x572>
  ...
  write(fd, "hello", SZ);
     ...
     d70:	99458593          	addi	a1,a1,-1644 # 6700 <lock_release+0x5a2>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8c:	94850513          	addi	a0,a0,-1720 # 66d0 <lock_release+0x572>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da2:	93250513          	addi	a0,a0,-1742 # 66d0 <lock_release+0x572>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db8:	91c50513          	addi	a0,a0,-1764 # 66d0 <lock_release+0x572>
  ...
  write(fd1, "yyy", 3);
     ...
     dcc:	98058593          	addi	a1,a1,-1664 # 6748 <lock_release+0x5ea>
  ...
  unlink("unlinkread");
     ...
     e34:	8a050513          	addi	a0,a0,-1888 # 66d0 <lock_release+0x572>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	89050513          	addi	a0,a0,-1904 # 66e0 <lock_release+0x582>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e70:	89c50513          	addi	a0,a0,-1892 # 6708 <lock_release+0x5aa>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8c:	8a050513          	addi	a0,a0,-1888 # 6728 <lock_release+0x5ca>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea8:	8ac50513          	addi	a0,a0,-1876 # 6750 <lock_release+0x5f2>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec4:	8b050513          	addi	a0,a0,-1872 # 6770 <lock_release+0x612>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee0:	8b450513          	addi	a0,a0,-1868 # 6790 <lock_release+0x632>
...
0000000000000ef6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	7c058593          	addi	a1,a1,1984 # 6700 <lock_release+0x5a2>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f64:	85858593          	addi	a1,a1,-1960 # 67b8 <lock_release+0x65a>
     f68:	00006517          	auipc	a0,0x6
     f6c:	84850513          	addi	a0,a0,-1976 # 67b0 <lock_release+0x652>
  ...
  unlink("lf1");
     ...
     f80:	83450513          	addi	a0,a0,-1996 # 67b0 <lock_release+0x652>
     f84:	00005097          	auipc	ra,0x5
     f88:	c9c080e7          	jalr	-868(ra) # 5c20 <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00006517          	auipc	a0,0x6
     f92:	82250513          	addi	a0,a0,-2014 # 67b0 <lock_release+0x652>
  ...
  fd = open("lf2", 0);
     ...
     fa8:	81450513          	addi	a0,a0,-2028 # 67b8 <lock_release+0x65a>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe0:	7dc58593          	addi	a1,a1,2012 # 67b8 <lock_release+0x65a>
     fe4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff6:	7c650513          	addi	a0,a0,1990 # 67b8 <lock_release+0x65a>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c26080e7          	jalr	-986(ra) # 5c20 <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00005597          	auipc	a1,0x5
    1006:	7ae58593          	addi	a1,a1,1966 # 67b0 <lock_release+0x652>
    100a:	00005517          	auipc	a0,0x5
    100e:	7ae50513          	addi	a0,a0,1966 # 67b8 <lock_release+0x65a>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1022:	79258593          	addi	a1,a1,1938 # 67b0 <lock_release+0x652>
    1026:	00006517          	auipc	a0,0x6
    102a:	89a50513          	addi	a0,a0,-1894 # 68c0 <lock_release+0x762>
    ...
    104c:	77850513          	addi	a0,a0,1912 # 67c0 <lock_release+0x662>
    ...
    1068:	77450513          	addi	a0,a0,1908 # 67d8 <lock_release+0x67a>
    ...
    1084:	77050513          	addi	a0,a0,1904 # 67f0 <lock_release+0x692>
    ...
    10a0:	77450513          	addi	a0,a0,1908 # 6810 <lock_release+0x6b2>
    ...
    10bc:	78850513          	addi	a0,a0,1928 # 6840 <lock_release+0x6e2>
    ...
    10d8:	78450513          	addi	a0,a0,1924 # 6858 <lock_release+0x6fa>
    ...
    10f4:	78050513          	addi	a0,a0,1920 # 6870 <lock_release+0x712>
    ...
    1110:	78c50513          	addi	a0,a0,1932 # 6898 <lock_release+0x73a>
    ...
    112c:	7a050513          	addi	a0,a0,1952 # 68c8 <lock_release+0x76a>
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	78e98993          	addi	s3,s3,1934 # 68e8 <lock_release+0x78a>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	76250513          	addi	a0,a0,1890 # 68f8 <lock_release+0x79a>
...
00000000000011b0 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1200:	71ca0a13          	addi	s4,s4,1820 # 6918 <lock_release+0x7ba>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1252:	6ca50513          	addi	a0,a0,1738 # 6918 <lock_release+0x7ba>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	66250513          	addi	a0,a0,1634 # 6920 <lock_release+0x7c2>
    ...
    12e2:	66250513          	addi	a0,a0,1634 # 6940 <lock_release+0x7e2>
    ...
    12fe:	66650513          	addi	a0,a0,1638 # 6960 <lock_release+0x802>
...
000000000000134c <badarg>:
{
    ...
    136a:	e7298993          	addi	s3,s3,-398 # 61d8 <lock_release+0x7a>
    argv[0] = (char*)0xffffffff;
...
0000000000001392 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f4:	7c878793          	addi	a5,a5,1992 # 7bb8 <lock_release+0x1a5a>
  ...
  if(pid == 0){
    ...
    1450:	18c78793          	addi	a5,a5,396 # 85d8 <lock_release+0x247a>
    ...
    1474:	d6850513          	addi	a0,a0,-664 # 61d8 <lock_release+0x7a>
    ...
    148c:	58050513          	addi	a0,a0,1408 # 6a08 <lock_release+0x8aa>
    ...
    14ac:	4d850513          	addi	a0,a0,1240 # 6980 <lock_release+0x822>
    ...
    14cc:	4d850513          	addi	a0,a0,1240 # 69a0 <lock_release+0x842>
    ...
    14ee:	4d650513          	addi	a0,a0,1238 # 69c0 <lock_release+0x862>
    ...
    150e:	4de50513          	addi	a0,a0,1246 # 69e8 <lock_release+0x88a>
    ...
    1528:	94450513          	addi	a0,a0,-1724 # 6e68 <lock_release+0xd0a>
  ...
  if(st != 747){
    ...
    1572:	4c250513          	addi	a0,a0,1218 # 6a30 <lock_release+0x8d2>
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a4:	c9050513          	addi	a0,a0,-880 # 6230 <lock_release+0xd2>
  ...
  if(pid == 0){
    ...
    15ce:	c66a0a13          	addi	s4,s4,-922 # 6230 <lock_release+0xd2>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	4bea8a93          	addi	s5,s5,1214 # 6a90 <lock_release+0x932>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    ...
    1646:	41e50513          	addi	a0,a0,1054 # 6a60 <lock_release+0x902>
    ...
    1662:	41a50513          	addi	a0,a0,1050 # 6a78 <lock_release+0x91a>
    ...
    1680:	42450513          	addi	a0,a0,1060 # 6aa0 <lock_release+0x942>
    ...
    169e:	b96a0a13          	addi	s4,s4,-1130 # 6230 <lock_release+0xd2>
    int n = write(fd, "xxx", 3);
    16a2:	00005a97          	auipc	s5,0x5
    16a6:	41ea8a93          	addi	s5,s5,1054 # 6ac0 <lock_release+0x962>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16f0:	b4450513          	addi	a0,a0,-1212 # 6230 <lock_release+0xd2>
  ...
  exit(xstatus);
    ...
    170e:	36e50513          	addi	a0,a0,878 # 6a78 <lock_release+0x91a>
    ...
    172c:	3a050513          	addi	a0,a0,928 # 6ac8 <lock_release+0x96a>
...
0000000000001742 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1754:	a8878793          	addi	a5,a5,-1400 # 61d8 <lock_release+0x7a>
    1758:	fcf43023          	sd	a5,-64(s0)
    175c:	00005797          	auipc	a5,0x5
    1760:	38c78793          	addi	a5,a5,908 # 6ae8 <lock_release+0x98a>
    1764:	fcf43423          	sd	a5,-56(s0)
    1768:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176c:	00005517          	auipc	a0,0x5
    1770:	38450513          	addi	a0,a0,900 # 6af0 <lock_release+0x992>
  ...
  if(pid == 0) {
    ...
    179e:	35650513          	addi	a0,a0,854 # 6af0 <lock_release+0x992>
    ...
    17ba:	35a50513          	addi	a0,a0,858 # 6b10 <lock_release+0x9b2>
    ...
    17d6:	28e50513          	addi	a0,a0,654 # 6a60 <lock_release+0x902>
    ...
    17f2:	30a50513          	addi	a0,a0,778 # 6af8 <lock_release+0x99a>
    ...
    1810:	9cc50513          	addi	a0,a0,-1588 # 61d8 <lock_release+0x7a>
  ...
  if(xstatus != 0)
    ...
    1844:	2e050513          	addi	a0,a0,736 # 6b20 <lock_release+0x9c2>
    ...
    1860:	2dc50513          	addi	a0,a0,732 # 6b38 <lock_release+0x9da>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1874:	28050513          	addi	a0,a0,640 # 6af0 <lock_release+0x992>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189e:	d0e50513          	addi	a0,a0,-754 # 65a8 <lock_release+0x44a>
    ...
    18ba:	1c250513          	addi	a0,a0,450 # 6a78 <lock_release+0x91a>
  ...
  unlink("echo-ok");
    ...
    18d4:	22050513          	addi	a0,a0,544 # 6af0 <lock_release+0x992>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fe:	25650513          	addi	a0,a0,598 # 6b50 <lock_release+0x9f2>
...
000000000000191e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19c0:	1ac50513          	addi	a0,a0,428 # 6b68 <lock_release+0xa0a>
    ...
    19fa:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a46:	13e50513          	addi	a0,a0,318 # 6b80 <lock_release+0xa22>
    ...
    1a62:	13a50513          	addi	a0,a0,314 # 6b98 <lock_release+0xa3a>
    ...
    1a94:	12050513          	addi	a0,a0,288 # 6bb0 <lock_release+0xa52>
    ...
    1ad4:	10050513          	addi	a0,a0,256 # 6bd0 <lock_release+0xa72>
...
0000000000001aea <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b46:	f1e50513          	addi	a0,a0,-226 # 6a60 <lock_release+0x902>
    ...
    1b62:	08a50513          	addi	a0,a0,138 # 6be8 <lock_release+0xa8a>
    ...
    1b7e:	08650513          	addi	a0,a0,134 # 6c00 <lock_release+0xaa2>
...
0000000000001b9e <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf6:	e6e50513          	addi	a0,a0,-402 # 6a60 <lock_release+0x902>
    ...
    1c1a:	e4a50513          	addi	a0,a0,-438 # 6a60 <lock_release+0x902>
...
0000000000001c38 <forkfork>:
{
    ...
    1c94:	f9050513          	addi	a0,a0,-112 # 6c20 <lock_release+0xac2>
    ...
    1ca6:	f2e080e7          	jalr	-210(ra) # 5bd0 <exit>
{
    ...
    1cec:	f4850513          	addi	a0,a0,-184 # 6c30 <lock_release+0xad2>
...
0000000000001d02 <reparent2>:
{
  ...
  exit(0);
    ...
    1d3a:	13250513          	addi	a0,a0,306 # 6e68 <lock_release+0xd0a>
...
0000000000001d6a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd8:	09450513          	addi	a0,a0,148 # 6e68 <lock_release+0xd0a>
    ...
    1e04:	cf850513          	addi	a0,a0,-776 # 6af8 <lock_release+0x99a>
    ...
    1e76:	dde50513          	addi	a0,a0,-546 # 6c50 <lock_release+0xaf2>
    ...
    1eaa:	dc250513          	addi	a0,a0,-574 # 6c68 <lock_release+0xb0a>
    ...
    1f10:	d8450513          	addi	a0,a0,-636 # 6c90 <lock_release+0xb32>
...
0000000000001f90 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb0:	29c50513          	addi	a0,a0,668 # 6248 <lock_release+0xea>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fec:	260a8a93          	addi	s5,s5,608 # 6248 <lock_release+0xea>
      link("cat", "x");
    1ff0:	00005b97          	auipc	s7,0x5
    1ff4:	cc8b8b93          	addi	s7,s7,-824 # 6cb8 <lock_release+0xb5a>
    1ff8:	a091                	j	203c <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1ffa:	85a6                	mv	a1,s1
    1ffc:	00005517          	auipc	a0,0x5
    2000:	a6450513          	addi	a0,a0,-1436 # 6a60 <lock_release+0x902>
...
0000000000002092 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20c2:	c1a50513          	addi	a0,a0,-998 # 6cd8 <lock_release+0xb7a>
  ...
  if(wait(0) != -1){
    ...
    2124:	ba050513          	addi	a0,a0,-1120 # 6cc0 <lock_release+0xb62>
    ...
    2140:	bc450513          	addi	a0,a0,-1084 # 6d00 <lock_release+0xba2>
    ...
    215c:	bc050513          	addi	a0,a0,-1088 # 6d18 <lock_release+0xbba>
...
0000000000002172 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21dc:	88850513          	addi	a0,a0,-1912 # 6a60 <lock_release+0x902>
    ...
    21fe:	b3650513          	addi	a0,a0,-1226 # 6d30 <lock_release+0xbd2>
...
000000000000221e <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2280:	7e450513          	addi	a0,a0,2020 # 6a60 <lock_release+0x902>
    ...
    22ac:	aa850513          	addi	a0,a0,-1368 # 6d50 <lock_release+0xbf2>
...
00000000000022cc <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22dc:	a9050513          	addi	a0,a0,-1392 # 6d68 <lock_release+0xc0a>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230e:	a5e50513          	addi	a0,a0,-1442 # 6d68 <lock_release+0xc0a>
  ...
  close(fd);
    ...
    2344:	a3870713          	addi	a4,a4,-1480 # 6d78 <lock_release+0xc1a>
    ...
    2398:	ac450513          	addi	a0,a0,-1340 # 6e58 <lock_release+0xcfa>
    ...
    23bc:	ac050513          	addi	a0,a0,-1344 # 6e78 <lock_release+0xd1a>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    241a:	a8250513          	addi	a0,a0,-1406 # 6e98 <lock_release+0xd3a>
    ...
    2436:	62e50513          	addi	a0,a0,1582 # 6a60 <lock_release+0x902>
...
0000000000002456 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a4:	5c050513          	addi	a0,a0,1472 # 6a60 <lock_release+0x902>
...
00000000000024c4 <manywrites>:
{
  ...
  exit(0);
    ...
    2520:	94c50513          	addi	a0,a0,-1716 # 6e68 <lock_release+0xd0a>
    ...
    25d0:	8f450513          	addi	a0,a0,-1804 # 6ec0 <lock_release+0xd62>
    ...
    25f0:	cbc50513          	addi	a0,a0,-836 # 62a8 <lock_release+0x14a>
...
000000000000260e <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2688:	53478793          	addi	a5,a5,1332 # 7bb8 <lock_release+0x1a5a>
  ...
  if(ret != -1){
    ...
    26ca:	81250513          	addi	a0,a0,-2030 # 6ed8 <lock_release+0xd7a>
    ...
    26e8:	29c50513          	addi	a0,a0,668 # 6980 <lock_release+0x822>
    ...
    2706:	29e50513          	addi	a0,a0,670 # 69a0 <lock_release+0x842>
    ...
    2726:	29e50513          	addi	a0,a0,670 # 69c0 <lock_release+0x862>
    ...
    2744:	2a850513          	addi	a0,a0,680 # 69e8 <lock_release+0x88a>
...
000000000000275a <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2790:	78c50513          	addi	a0,a0,1932 # 6f18 <lock_release+0xdba>
  ...
  if(n >= 0){
    ...
    27c2:	77a50513          	addi	a0,a0,1914 # 6f38 <lock_release+0xdda>
    ...
    27dc:	70850513          	addi	a0,a0,1800 # 6ee0 <lock_release+0xd82>
    ...
    27f6:	70650513          	addi	a0,a0,1798 # 6ef8 <lock_release+0xd9a>
    ...
    2810:	71450513          	addi	a0,a0,1812 # 6f20 <lock_release+0xdc2>
  ...
  unlink("rwsbrk");
    ...
    2834:	6e850513          	addi	a0,a0,1768 # 6f18 <lock_release+0xdba>
    2838:	00003097          	auipc	ra,0x3
    283c:	3e8080e7          	jalr	1000(ra) # 5c20 <unlink>
  fd = open("README", O_RDONLY);
    2840:	4581                	li	a1,0
    2842:	00004517          	auipc	a0,0x4
    2846:	b6e50513          	addi	a0,a0,-1170 # 63b0 <lock_release+0x252>
  ...
  if(n >= 0){
    ...
    2870:	6fc50513          	addi	a0,a0,1788 # 6f68 <lock_release+0xe0a>
    ...
    288a:	69a50513          	addi	a0,a0,1690 # 6f20 <lock_release+0xdc2>
...
00000000000028b4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    290c:	68850513          	addi	a0,a0,1672 # 6f90 <lock_release+0xe32>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2960:	65450513          	addi	a0,a0,1620 # 6fb0 <lock_release+0xe52>
  ...
  if(c != a + 1){
    ...
    29c2:	65250513          	addi	a0,a0,1618 # 7010 <lock_release+0xeb2>
    ...
    29e4:	5f050513          	addi	a0,a0,1520 # 6fd0 <lock_release+0xe72>
    ...
    2a00:	5f450513          	addi	a0,a0,1524 # 6ff0 <lock_release+0xe92>
...
0000000000002a3c <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b4a:	4ea50513          	addi	a0,a0,1258 # 7030 <lock_release+0xed2>
    ...
    2b66:	51650513          	addi	a0,a0,1302 # 7078 <lock_release+0xf1a>
    ...
    2b86:	51650513          	addi	a0,a0,1302 # 7098 <lock_release+0xf3a>
    ...
    2ba6:	53650513          	addi	a0,a0,1334 # 70d8 <lock_release+0xf7a>
    ...
    2bc2:	54a50513          	addi	a0,a0,1354 # 7108 <lock_release+0xfaa>
    ...
    2be2:	56250513          	addi	a0,a0,1378 # 7140 <lock_release+0xfe2>
...
0000000000002bf8 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c1c:	55050513          	addi	a0,a0,1360 # 7168 <lock_release+0x100a>
    2c20:	00003097          	auipc	ra,0x3
    2c24:	ff0080e7          	jalr	-16(ra) # 5c10 <open>
    2c28:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c2a:	00004517          	auipc	a0,0x4
    2c2e:	53e50513          	addi	a0,a0,1342 # 7168 <lock_release+0x100a>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c82:	4f250513          	addi	a0,a0,1266 # 7170 <lock_release+0x1012>
    ...
    2c9e:	4ee50513          	addi	a0,a0,1262 # 7188 <lock_release+0x102a>
    ...
    2cba:	eb250513          	addi	a0,a0,-334 # 6b68 <lock_release+0xa0a>
...
0000000000002cd0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2ce4:	4c050513          	addi	a0,a0,1216 # 71a0 <lock_release+0x1042>
  ...
  close(fd);
    ...
    2d2c:	d5050513          	addi	a0,a0,-688 # 6a78 <lock_release+0x91a>
...
0000000000002d42 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d7a:	0f250513          	addi	a0,a0,242 # 6e68 <lock_release+0xd0a>
  ...
  if(pid == 0){
    ...
    2dd0:	09c50513          	addi	a0,a0,156 # 6e68 <lock_release+0xd0a>
  ...
  if(pid == 0){
    ...
    2e30:	03c50513          	addi	a0,a0,60 # 6e68 <lock_release+0xd0a>
...
0000000000002f62 <execout>:
{
  ...
  exit(0);
    ...
    2fa4:	ec850513          	addi	a0,a0,-312 # 6e68 <lock_release+0xd0a>
    ...
    2ff8:	1e450513          	addi	a0,a0,484 # 61d8 <lock_release+0x7a>
    2ffc:	faa43c23          	sd	a0,-72(s0)
    3000:	00003797          	auipc	a5,0x3
    3004:	24878793          	addi	a5,a5,584 # 6248 <lock_release+0xea>
...
0000000000003026 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3036:	34650513          	addi	a0,a0,838 # 7378 <lock_release+0x121a>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3048:	18c50513          	addi	a0,a0,396 # 71d0 <lock_release+0x1072>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    305e:	1ce50513          	addi	a0,a0,462 # 7228 <lock_release+0x10ca>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    307c:	22850513          	addi	a0,a0,552 # 72a0 <lock_release+0x1142>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3098:	27c50513          	addi	a0,a0,636 # 7310 <lock_release+0x11b2>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30aa:	2c250513          	addi	a0,a0,706 # 7368 <lock_release+0x120a>
  ...
  unlink("12345678901234");
    ...
    3128:	08450513          	addi	a0,a0,132 # 71a8 <lock_release+0x104a>
    ...
    3144:	0b050513          	addi	a0,a0,176 # 71f0 <lock_release+0x1092>
    ...
    3160:	0fc50513          	addi	a0,a0,252 # 7258 <lock_release+0x10fa>
    ...
    317c:	15850513          	addi	a0,a0,344 # 72d0 <lock_release+0x1172>
    ...
    3198:	19c50513          	addi	a0,a0,412 # 7330 <lock_release+0x11d2>
    ...
    31b4:	1d850513          	addi	a0,a0,472 # 7388 <lock_release+0x122a>
...
00000000000031ca <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    3200:	1c450513          	addi	a0,a0,452 # 73c0 <lock_release+0x1262>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    322a:	1aa50513          	addi	a0,a0,426 # 73d0 <lock_release+0x1272>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32ba:	10a50513          	addi	a0,a0,266 # 73c0 <lock_release+0x1262>
  ...
  unlink("diskfulldir");
    ...
    32ce:	0f650513          	addi	a0,a0,246 # 73c0 <lock_release+0x1262>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33fc:	ff850513          	addi	a0,a0,-8 # 73f0 <lock_release+0x1292>
...
000000000000340a <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    341a:	00a50513          	addi	a0,a0,10 # 7420 <lock_release+0x12c2>
  ...
  if(chdir("iputdir") < 0){
    ...
    342e:	ff650513          	addi	a0,a0,-10 # 7420 <lock_release+0x12c2>
  ...
  if(unlink("../iputdir") < 0){
    ...
    3442:	02250513          	addi	a0,a0,34 # 7460 <lock_release+0x1302>
  ...
  if(chdir("/") < 0){
    ...
    3456:	03e50513          	addi	a0,a0,62 # 7490 <lock_release+0x1332>
    ...
    3476:	fb650513          	addi	a0,a0,-74 # 7428 <lock_release+0x12ca>
    ...
    3492:	fb250513          	addi	a0,a0,-78 # 7440 <lock_release+0x12e2>
    ...
    34ae:	fc650513          	addi	a0,a0,-58 # 7470 <lock_release+0x1312>
    ...
    34ca:	fd250513          	addi	a0,a0,-46 # 7498 <lock_release+0x133a>
...
00000000000034e0 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34fe:	f2650513          	addi	a0,a0,-218 # 7420 <lock_release+0x12c2>
    ...
    3512:	f1250513          	addi	a0,a0,-238 # 7420 <lock_release+0x12c2>
    ...
    3526:	f3e50513          	addi	a0,a0,-194 # 7460 <lock_release+0x1302>
    ...
    3546:	51e50513          	addi	a0,a0,1310 # 6a60 <lock_release+0x902>
    ...
    3562:	eca50513          	addi	a0,a0,-310 # 7428 <lock_release+0x12ca>
    ...
    357e:	f3650513          	addi	a0,a0,-202 # 74b0 <lock_release+0x1352>
    ...
    359a:	eda50513          	addi	a0,a0,-294 # 7470 <lock_release+0x1312>
...
00000000000035c8 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d8:	ef450513          	addi	a0,a0,-268 # 74c8 <lock_release+0x136a>
  ...
  if(chdir("dir0") < 0){
    ...
    35ec:	ee050513          	addi	a0,a0,-288 # 74c8 <lock_release+0x136a>
  ...
  if(chdir("..") < 0){
    ...
    3600:	eec50513          	addi	a0,a0,-276 # 74e8 <lock_release+0x138a>
  ...
  if(unlink("dir0") < 0){
    ...
    3614:	eb850513          	addi	a0,a0,-328 # 74c8 <lock_release+0x136a>
    ...
    3634:	df850513          	addi	a0,a0,-520 # 7428 <lock_release+0x12ca>
    ...
    3650:	e8450513          	addi	a0,a0,-380 # 74d0 <lock_release+0x1372>
    ...
    366c:	e8850513          	addi	a0,a0,-376 # 74f0 <lock_release+0x1392>
    ...
    3688:	e8450513          	addi	a0,a0,-380 # 7508 <lock_release+0x13aa>
...
000000000000369e <subdir>:
{
  ...
  unlink("ff");
    ...
    36b0:	fa450513          	addi	a0,a0,-92 # 7650 <lock_release+0x14f2>
    36b4:	00002097          	auipc	ra,0x2
    36b8:	56c080e7          	jalr	1388(ra) # 5c20 <unlink>
  if(mkdir("dd") != 0){
    36bc:	00004517          	auipc	a0,0x4
    36c0:	e6450513          	addi	a0,a0,-412 # 7520 <lock_release+0x13c2>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d8:	e6c50513          	addi	a0,a0,-404 # 7540 <lock_release+0x13e2>
  ...
  write(fd, "ff", 2);
    ...
    36f0:	f6458593          	addi	a1,a1,-156 # 7650 <lock_release+0x14f2>
  ...
  if(unlink("dd") >= 0){
    ...
    370a:	e1a50513          	addi	a0,a0,-486 # 7520 <lock_release+0x13c2>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    371e:	e7e50513          	addi	a0,a0,-386 # 7598 <lock_release+0x143a>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3736:	e8e50513          	addi	a0,a0,-370 # 75c0 <lock_release+0x1462>
  ...
  write(fd, "FF", 2);
    ...
    374e:	ea658593          	addi	a1,a1,-346 # 75f0 <lock_release+0x1492>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    376a:	e9250513          	addi	a0,a0,-366 # 75f8 <lock_release+0x149a>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37b2:	e9a58593          	addi	a1,a1,-358 # 7648 <lock_release+0x14ea>
    37b6:	00004517          	auipc	a0,0x4
    37ba:	e0a50513          	addi	a0,a0,-502 # 75c0 <lock_release+0x1462>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37ce:	df650513          	addi	a0,a0,-522 # 75c0 <lock_release+0x1462>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37e4:	de050513          	addi	a0,a0,-544 # 75c0 <lock_release+0x1462>
  ...
  if(chdir("dd") != 0){
    ...
    37f8:	d2c50513          	addi	a0,a0,-724 # 7520 <lock_release+0x13c2>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    380c:	ed850513          	addi	a0,a0,-296 # 76e0 <lock_release+0x1582>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3820:	ef450513          	addi	a0,a0,-268 # 7710 <lock_release+0x15b2>
  ...
  if(chdir("./..") != 0){
    ...
    3834:	f1050513          	addi	a0,a0,-240 # 7740 <lock_release+0x15e2>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    384a:	e0250513          	addi	a0,a0,-510 # 7648 <lock_release+0x14ea>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3884:	d4050513          	addi	a0,a0,-704 # 75c0 <lock_release+0x1462>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    389c:	f3850513          	addi	a0,a0,-200 # 77d0 <lock_release+0x1672>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b4:	f5050513          	addi	a0,a0,-176 # 7800 <lock_release+0x16a2>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38cc:	c5850513          	addi	a0,a0,-936 # 7520 <lock_release+0x13c2>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38e2:	c4250513          	addi	a0,a0,-958 # 7520 <lock_release+0x13c2>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f8:	c2c50513          	addi	a0,a0,-980 # 7520 <lock_release+0x13c2>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    390c:	f8858593          	addi	a1,a1,-120 # 7890 <lock_release+0x1732>
    3910:	00004517          	auipc	a0,0x4
    3914:	ec050513          	addi	a0,a0,-320 # 77d0 <lock_release+0x1672>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3928:	f6c58593          	addi	a1,a1,-148 # 7890 <lock_release+0x1732>
    392c:	00004517          	auipc	a0,0x4
    3930:	ed450513          	addi	a0,a0,-300 # 7800 <lock_release+0x16a2>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3944:	d0858593          	addi	a1,a1,-760 # 7648 <lock_release+0x14ea>
    3948:	00004517          	auipc	a0,0x4
    394c:	bf850513          	addi	a0,a0,-1032 # 7540 <lock_release+0x13e2>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3960:	e7450513          	addi	a0,a0,-396 # 77d0 <lock_release+0x1672>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3974:	e9050513          	addi	a0,a0,-368 # 7800 <lock_release+0x16a2>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3988:	cc450513          	addi	a0,a0,-828 # 7648 <lock_release+0x14ea>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    399c:	e6850513          	addi	a0,a0,-408 # 7800 <lock_release+0x16a2>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39b0:	e2450513          	addi	a0,a0,-476 # 77d0 <lock_release+0x1672>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39c4:	b8050513          	addi	a0,a0,-1152 # 7540 <lock_release+0x13e2>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d8:	00c50513          	addi	a0,a0,12 # 79e0 <lock_release+0x1882>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39ec:	c6050513          	addi	a0,a0,-928 # 7648 <lock_release+0x14ea>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a00:	b4450513          	addi	a0,a0,-1212 # 7540 <lock_release+0x13e2>
  ...
  if(unlink("dd") == 0){
    ...
    3a14:	b1050513          	addi	a0,a0,-1264 # 7520 <lock_release+0x13c2>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a28:	02c50513          	addi	a0,a0,44 # 7a50 <lock_release+0x18f2>
  ...
  if(unlink("dd") < 0){
    ...
    3a3c:	ae850513          	addi	a0,a0,-1304 # 7520 <lock_release+0x13c2>
    ...
    3a5e:	ace50513          	addi	a0,a0,-1330 # 7528 <lock_release+0x13ca>
    ...
    3a7a:	ad250513          	addi	a0,a0,-1326 # 7548 <lock_release+0x13ea>
    ...
    3a96:	ad650513          	addi	a0,a0,-1322 # 7568 <lock_release+0x140a>
    ...
    3ab2:	af250513          	addi	a0,a0,-1294 # 75a0 <lock_release+0x1442>
    ...
    3ace:	b0650513          	addi	a0,a0,-1274 # 75d0 <lock_release+0x1472>
    ...
    3aea:	b2250513          	addi	a0,a0,-1246 # 7608 <lock_release+0x14aa>
    ...
    3b06:	b2650513          	addi	a0,a0,-1242 # 7628 <lock_release+0x14ca>
    ...
    3b22:	b3a50513          	addi	a0,a0,-1222 # 7658 <lock_release+0x14fa>
    ...
    3b3e:	b4650513          	addi	a0,a0,-1210 # 7680 <lock_release+0x1522>
    ...
    3b5a:	b4a50513          	addi	a0,a0,-1206 # 76a0 <lock_release+0x1542>
    ...
    3b76:	b5650513          	addi	a0,a0,-1194 # 76c8 <lock_release+0x156a>
    ...
    3b92:	b6250513          	addi	a0,a0,-1182 # 76f0 <lock_release+0x1592>
    ...
    3bae:	b7650513          	addi	a0,a0,-1162 # 7720 <lock_release+0x15c2>
    ...
    3bca:	b8250513          	addi	a0,a0,-1150 # 7748 <lock_release+0x15ea>
    ...
    3be6:	b7e50513          	addi	a0,a0,-1154 # 7760 <lock_release+0x1602>
    ...
    3c02:	b8250513          	addi	a0,a0,-1150 # 7780 <lock_release+0x1622>
    ...
    3c1e:	b8650513          	addi	a0,a0,-1146 # 77a0 <lock_release+0x1642>
    ...
    3c3a:	baa50513          	addi	a0,a0,-1110 # 77e0 <lock_release+0x1682>
    ...
    3c56:	bbe50513          	addi	a0,a0,-1090 # 7810 <lock_release+0x16b2>
    ...
    3c72:	bc250513          	addi	a0,a0,-1086 # 7830 <lock_release+0x16d2>
    ...
    3c8e:	bc650513          	addi	a0,a0,-1082 # 7850 <lock_release+0x16f2>
    ...
    3caa:	bca50513          	addi	a0,a0,-1078 # 7870 <lock_release+0x1712>
    ...
    3cc6:	bde50513          	addi	a0,a0,-1058 # 78a0 <lock_release+0x1742>
    ...
    3ce2:	bea50513          	addi	a0,a0,-1046 # 78c8 <lock_release+0x176a>
    ...
    3cfe:	bf650513          	addi	a0,a0,-1034 # 78f0 <lock_release+0x1792>
    ...
    3d1a:	c0250513          	addi	a0,a0,-1022 # 7918 <lock_release+0x17ba>
    ...
    3d36:	c0650513          	addi	a0,a0,-1018 # 7938 <lock_release+0x17da>
    ...
    3d52:	c0a50513          	addi	a0,a0,-1014 # 7958 <lock_release+0x17fa>
    ...
    3d6e:	c1650513          	addi	a0,a0,-1002 # 7980 <lock_release+0x1822>
    ...
    3d8a:	c1a50513          	addi	a0,a0,-998 # 79a0 <lock_release+0x1842>
    ...
    3da6:	c1e50513          	addi	a0,a0,-994 # 79c0 <lock_release+0x1862>
    ...
    3dc2:	c2a50513          	addi	a0,a0,-982 # 79e8 <lock_release+0x188a>
    ...
    3dde:	8a650513          	addi	a0,a0,-1882 # 7680 <lock_release+0x1522>
    ...
    3dfa:	c1250513          	addi	a0,a0,-1006 # 7a08 <lock_release+0x18aa>
    ...
    3e16:	c1650513          	addi	a0,a0,-1002 # 7a28 <lock_release+0x18ca>
    ...
    3e32:	c2a50513          	addi	a0,a0,-982 # 7a58 <lock_release+0x18fa>
    ...
    3e4e:	c2e50513          	addi	a0,a0,-978 # 7a78 <lock_release+0x191a>
...
0000000000003e64 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e74:	c2050513          	addi	a0,a0,-992 # 7a90 <lock_release+0x1932>
  ...
  if(chdir("dots") != 0){
    ...
    3e86:	c0e50513          	addi	a0,a0,-1010 # 7a90 <lock_release+0x1932>
  ...
  if(unlink(".") == 0){
    ...
    3e98:	a2c50513          	addi	a0,a0,-1492 # 68c0 <lock_release+0x762>
  ...
  if(unlink("..") == 0){
    ...
    3eaa:	64250513          	addi	a0,a0,1602 # 74e8 <lock_release+0x138a>
  ...
  if(chdir("/") != 0){
    ...
    3ebc:	5d850513          	addi	a0,a0,1496 # 7490 <lock_release+0x1332>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ece:	c2e50513          	addi	a0,a0,-978 # 7af8 <lock_release+0x199a>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ee0:	c4450513          	addi	a0,a0,-956 # 7b20 <lock_release+0x19c2>
  ...
  if(unlink("dots") != 0){
    ...
    3ef2:	ba250513          	addi	a0,a0,-1118 # 7a90 <lock_release+0x1932>
    ...
    3f10:	b8c50513          	addi	a0,a0,-1140 # 7a98 <lock_release+0x193a>
    ...
    3f2c:	b8850513          	addi	a0,a0,-1144 # 7ab0 <lock_release+0x1952>
    ...
    3f48:	b8450513          	addi	a0,a0,-1148 # 7ac8 <lock_release+0x196a>
    ...
    3f64:	b8050513          	addi	a0,a0,-1152 # 7ae0 <lock_release+0x1982>
    ...
    3f80:	51c50513          	addi	a0,a0,1308 # 7498 <lock_release+0x133a>
    ...
    3f9c:	b6850513          	addi	a0,a0,-1176 # 7b00 <lock_release+0x19a2>
    ...
    3fb8:	b7450513          	addi	a0,a0,-1164 # 7b28 <lock_release+0x19ca>
    ...
    3fd4:	b7850513          	addi	a0,a0,-1160 # 7b48 <lock_release+0x19ea>
...
0000000000003fea <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4000:	b6c50513          	addi	a0,a0,-1172 # 7b68 <lock_release+0x1a0a>
  ...
  if(chdir("dirfile") == 0){
    ...
    401c:	b5050513          	addi	a0,a0,-1200 # 7b68 <lock_release+0x1a0a>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4030:	b8450513          	addi	a0,a0,-1148 # 7bb0 <lock_release+0x1a52>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4048:	b6c50513          	addi	a0,a0,-1172 # 7bb0 <lock_release+0x1a52>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    405c:	b5850513          	addi	a0,a0,-1192 # 7bb0 <lock_release+0x1a52>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4070:	b4450513          	addi	a0,a0,-1212 # 7bb0 <lock_release+0x1a52>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4084:	b3058593          	addi	a1,a1,-1232 # 7bb0 <lock_release+0x1a52>
    4088:	00002517          	auipc	a0,0x2
    408c:	32850513          	addi	a0,a0,808 # 63b0 <lock_release+0x252>
  ...
  if(unlink("dirfile") != 0){
    ...
    40a0:	acc50513          	addi	a0,a0,-1332 # 7b68 <lock_release+0x1a0a>
    40a4:	00002097          	auipc	ra,0x2
    40a8:	b7c080e7          	jalr	-1156(ra) # 5c20 <unlink>
    40ac:	10051f63          	bnez	a0,41ca <dirfile+0x1e0>
  fd = open(".", O_RDWR);
    40b0:	4589                	li	a1,2
    40b2:	00003517          	auipc	a0,0x3
    40b6:	80e50513          	addi	a0,a0,-2034 # 68c0 <lock_release+0x762>
  ...
  fd = open(".", 0);
    ...
    40cc:	7f850513          	addi	a0,a0,2040 # 68c0 <lock_release+0x762>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40e0:	16c58593          	addi	a1,a1,364 # 6248 <lock_release+0xea>
  ...
  close(fd);
    ...
    410c:	a6850513          	addi	a0,a0,-1432 # 7b70 <lock_release+0x1a12>
    ...
    4128:	a6c50513          	addi	a0,a0,-1428 # 7b90 <lock_release+0x1a32>
    ...
    4144:	a8050513          	addi	a0,a0,-1408 # 7bc0 <lock_release+0x1a62>
    ...
    4160:	a6450513          	addi	a0,a0,-1436 # 7bc0 <lock_release+0x1a62>
    ...
    417c:	a7050513          	addi	a0,a0,-1424 # 7be8 <lock_release+0x1a8a>
    ...
    4198:	a7c50513          	addi	a0,a0,-1412 # 7c10 <lock_release+0x1ab2>
    ...
    41b4:	a8850513          	addi	a0,a0,-1400 # 7c38 <lock_release+0x1ada>
    ...
    41d0:	a9450513          	addi	a0,a0,-1388 # 7c60 <lock_release+0x1b02>
    ...
    41ec:	a9850513          	addi	a0,a0,-1384 # 7c80 <lock_release+0x1b22>
    ...
    4208:	aa450513          	addi	a0,a0,-1372 # 7ca8 <lock_release+0x1b4a>
...
000000000000421e <iref>:
{
    ...
    423c:	a88a0a13          	addi	s4,s4,-1400 # 7cc0 <lock_release+0x1b62>
    mkdir("");
    4240:	00003497          	auipc	s1,0x3
    4244:	58848493          	addi	s1,s1,1416 # 77c8 <lock_release+0x166a>
    link("README", "");
    4248:	00002a97          	auipc	s5,0x2
    424c:	168a8a93          	addi	s5,s5,360 # 63b0 <lock_release+0x252>
    fd = open("xx", O_CREATE);
    4250:	00004997          	auipc	s3,0x4
    4254:	96898993          	addi	s3,s3,-1688 # 7bb8 <lock_release+0x1a5a>
    4258:	a891                	j	42ac <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    425a:	85da                	mv	a1,s6
    425c:	00004517          	auipc	a0,0x4
    4260:	a6c50513          	addi	a0,a0,-1428 # 7cc8 <lock_release+0x1b6a>
    ...
    427c:	a6850513          	addi	a0,a0,-1432 # 7ce0 <lock_release+0x1b82>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4310:	1dc98993          	addi	s3,s3,476 # 74e8 <lock_release+0x138a>
    unlink("irefd");
    4314:	00004917          	auipc	s2,0x4
    4318:	9ac90913          	addi	s2,s2,-1620 # 7cc0 <lock_release+0x1b62>
    chdir("..");
    431c:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4338:	15c50513          	addi	a0,a0,348 # 7490 <lock_release+0x1332>
...
0000000000004358 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4368:	99450513          	addi	a0,a0,-1644 # 7cf8 <lock_release+0x1b9a>
  ...
  if(pid == 0){
    ...
    438c:	97050513          	addi	a0,a0,-1680 # 7cf8 <lock_release+0x1b9a>
    ...
    43a2:	97a50513          	addi	a0,a0,-1670 # 7d18 <lock_release+0x1bba>
    ...
    43be:	94650513          	addi	a0,a0,-1722 # 7d00 <lock_release+0x1ba2>
    ...
    43da:	68a50513          	addi	a0,a0,1674 # 6a60 <lock_release+0x902>
  ...
  if(unlink("oidir") != 0){
    ...
    4408:	8f450513          	addi	a0,a0,-1804 # 7cf8 <lock_release+0x1b9a>
    ...
    441c:	83850513          	addi	a0,a0,-1992 # 6c50 <lock_release+0xaf2>
...
000000000000444a <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    445a:	8ea50513          	addi	a0,a0,-1814 # 7d40 <lock_release+0x1be2>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4486:	8be50513          	addi	a0,a0,-1858 # 7d40 <lock_release+0x1be2>
  ...
  sleep(10); // one second
    ...
    44be:	76650513          	addi	a0,a0,1894 # 6c20 <lock_release+0xac2>
    ...
    44d8:	86c48493          	addi	s1,s1,-1940 # 7d40 <lock_release+0x1be2>
    44dc:	4581                	li	a1,0
    44de:	8526                	mv	a0,s1
...
000000000000451a <killstatus>:
{
  ...
  exit(0);
    ...
    4580:	4e450513          	addi	a0,a0,1252 # 6a60 <lock_release+0x902>
    ...
    45a6:	7ae50513          	addi	a0,a0,1966 # 7d50 <lock_release+0x1bf2>
...
00000000000045bc <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e6:	63e50513          	addi	a0,a0,1598 # 6c20 <lock_release+0xac2>
  ...
  if(pid2 == 0)
    ...
    4614:	45050513          	addi	a0,a0,1104 # 6a60 <lock_release+0x902>
  ...
  if(pid3 == 0){
    ...
    4658:	bf458593          	addi	a1,a1,-1036 # 6248 <lock_release+0xea>
    ...
    4682:	3e250513          	addi	a0,a0,994 # 6a60 <lock_release+0x902>
    ...
    469e:	6d650513          	addi	a0,a0,1750 # 7d70 <lock_release+0x1c12>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46da:	6b250513          	addi	a0,a0,1714 # 7d88 <lock_release+0x1c2a>
  ...
  printf("kill... ");
    ...
    4706:	69e50513          	addi	a0,a0,1694 # 7da0 <lock_release+0x1c42>
  ...
  printf("wait... ");
    ...
    4734:	68050513          	addi	a0,a0,1664 # 7db0 <lock_release+0x1c52>
...
0000000000004760 <reparent>:
{
  ...
  exit(0);
    ...
    47b4:	2b050513          	addi	a0,a0,688 # 6a60 <lock_release+0x902>
    ...
    47d0:	41c50513          	addi	a0,a0,1052 # 6be8 <lock_release+0xa8a>
...
0000000000004810 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4846:	32650513          	addi	a0,a0,806 # 6b68 <lock_release+0xa0a>
    ...
    487c:	9d058593          	addi	a1,a1,-1584 # 6248 <lock_release+0xea>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4940:	48450513          	addi	a0,a0,1156 # 7dc0 <lock_release+0x1c62>
    ...
    495c:	10850513          	addi	a0,a0,264 # 6a60 <lock_release+0x902>
    ...
    49a8:	43c50513          	addi	a0,a0,1084 # 7de0 <lock_release+0x1c82>
...
00000000000049c8 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a30:	3e450513          	addi	a0,a0,996 # 7e10 <lock_release+0x1cb2>
...
0000000000004a6e <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4b04:	34050513          	addi	a0,a0,832 # 7e40 <lock_release+0x1ce2>
    ...
    4b20:	34c50513          	addi	a0,a0,844 # 7e68 <lock_release+0x1d0a>
  ...
  fd = open("sharedfd", 0);
    ...
    4b64:	2d050513          	addi	a0,a0,720 # 7e30 <lock_release+0x1cd2>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4ba4:	2e850513          	addi	a0,a0,744 # 7e88 <lock_release+0x1d2a>
  ...
  unlink("sharedfd");
    ...
    4be0:	25450513          	addi	a0,a0,596 # 7e30 <lock_release+0x1cd2>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c06:	2ae50513          	addi	a0,a0,686 # 7eb0 <lock_release+0x1d52>
...
0000000000004c26 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c4a:	53a78793          	addi	a5,a5,1338 # 6180 <lock_release+0x22>
    4c4e:	f6f43823          	sd	a5,-144(s0)
    4c52:	00001797          	auipc	a5,0x1
    4c56:	53678793          	addi	a5,a5,1334 # 6188 <lock_release+0x2a>
    4c5a:	f6f43c23          	sd	a5,-136(s0)
    4c5e:	00001797          	auipc	a5,0x1
    4c62:	53278793          	addi	a5,a5,1330 # 6190 <lock_release+0x32>
    4c66:	f8f43023          	sd	a5,-128(s0)
    4c6a:	00001797          	auipc	a5,0x1
    4c6e:	52e78793          	addi	a5,a5,1326 # 6198 <lock_release+0x3a>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4ce6:	18650513          	addi	a0,a0,390 # 6e68 <lock_release+0xd0a>
    ...
    4d60:	16c50513          	addi	a0,a0,364 # 7ec8 <lock_release+0x1d6a>
    ...
    4d7a:	16250513          	addi	a0,a0,354 # 7ed8 <lock_release+0x1d7a>
    ...
    4d9e:	15650513          	addi	a0,a0,342 # 7ef0 <lock_release+0x1d92>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e2e:	0d650513          	addi	a0,a0,214 # 7f00 <lock_release+0x1da2>
...
0000000000004e62 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e90:	08cb8b93          	addi	s7,s7,140 # 7f18 <lock_release+0x1dba>
  for(i = 0; i < N; i++){
    ...
    4ed2:	05250513          	addi	a0,a0,82 # 7f20 <lock_release+0x1dc2>
    ...
    4ef0:	02c50513          	addi	a0,a0,44 # 7f18 <lock_release+0x1dba>
  ...
  fd = open(".", 0);
    ...
    4f28:	99c50513          	addi	a0,a0,-1636 # 68c0 <lock_release+0x762>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f4e:	ff650513          	addi	a0,a0,-10 # 7f40 <lock_release+0x1de2>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4fbe:	fa650513          	addi	a0,a0,-90 # 7f60 <lock_release+0x1e02>
  ...
  for(i = 0; i < N; i++){
    ...
    4ff6:	f9650513          	addi	a0,a0,-106 # 7f88 <lock_release+0x1e2a>
    ...
    5012:	a5250513          	addi	a0,a0,-1454 # 6a60 <lock_release+0x902>
...
00000000000051bc <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5244:	d8050513          	addi	a0,a0,-640 # 7fc0 <lock_release+0x1e62>
  ...
  for(i = 0; ; i++){
    ...
    52a8:	d2c50513          	addi	a0,a0,-724 # 7fd0 <lock_release+0x1e72>
    ...
    52c4:	d3050513          	addi	a0,a0,-720 # 7ff0 <lock_release+0x1e92>
    ...
    52e0:	d3450513          	addi	a0,a0,-716 # 8010 <lock_release+0x1eb2>
    ...
    52fc:	d3850513          	addi	a0,a0,-712 # 8030 <lock_release+0x1ed2>
    ...
    5318:	d3c50513          	addi	a0,a0,-708 # 8050 <lock_release+0x1ef2>
    ...
    5334:	d3850513          	addi	a0,a0,-712 # 8068 <lock_release+0x1f0a>
  ...
  unlink("bigfile.dat");
    ...
    5362:	c6250513          	addi	a0,a0,-926 # 7fc0 <lock_release+0x1e62>
    ...
    5386:	d0650513          	addi	a0,a0,-762 # 8088 <lock_release+0x1f2a>
...
000000000000539c <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53be:	cee50513          	addi	a0,a0,-786 # 80a8 <lock_release+0x1f4a>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53de:	cdec8c93          	addi	s9,s9,-802 # 80b8 <lock_release+0x1f5a>
    int total = 0;
    53e2:	4d81                	li	s11,0
    ...
    5458:	c7450513          	addi	a0,a0,-908 # 80c8 <lock_release+0x1f6a>
  ...
  printf("fsfull test finished\n");
    ...
    54ce:	c1e50513          	addi	a0,a0,-994 # 80e8 <lock_release+0x1f8a>
    ...
    551e:	bbe50513          	addi	a0,a0,-1090 # 80d8 <lock_release+0x1f7a>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5550:	bb450513          	addi	a0,a0,-1100 # 8100 <lock_release+0x1fa2>
  ...
  if(pid == 0) {
    ...
    5580:	bac50513          	addi	a0,a0,-1108 # 8128 <lock_release+0x1fca>
    ...
    55a4:	b7050513          	addi	a0,a0,-1168 # 8110 <lock_release+0x1fb2>
    ...
    55cc:	b6850513          	addi	a0,a0,-1176 # 8130 <lock_release+0x1fd2>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    561c:	b2050513          	addi	a0,a0,-1248 # 8138 <lock_release+0x1fda>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5676:	bd690913          	addi	s2,s2,-1066 # 6248 <lock_release+0xea>
      uint64 a = (uint64) sbrk(4096);
    ...
    56aa:	aea50513          	addi	a0,a0,-1302 # 8190 <lock_release+0x2032>
    ...
    56c4:	a9050513          	addi	a0,a0,-1392 # 8150 <lock_release+0x1ff2>
    ...
    56de:	a9650513          	addi	a0,a0,-1386 # 8170 <lock_release+0x2012>
  ...
  while(1){
    ...
    572c:	a8850513          	addi	a0,a0,-1400 # 81b0 <lock_release+0x2052>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    578e:	a46b8b93          	addi	s7,s7,-1466 # 81d0 <lock_release+0x2072>
    int free0 = countfree();
    int free1 = 0;
    ...
    57a0:	a6cc8c93          	addi	s9,s9,-1428 # 8208 <lock_release+0x20aa>
      if (runtests(slowtests, justone)) {
    57a4:	00004c17          	auipc	s8,0x4
    57a8:	c3cc0c13          	addi	s8,s8,-964 # 93e0 <slowtests>
        printf("usertests slow tests starting\n");
    57ac:	00003d17          	auipc	s10,0x3
    57b0:	a3cd0d13          	addi	s10,s10,-1476 # 81e8 <lock_release+0x208a>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58a6:	99658593          	addi	a1,a1,-1642 # 8238 <lock_release+0x20da>
    ...
    58bc:	9d858593          	addi	a1,a1,-1576 # 8290 <lock_release+0x2132>
    ...
    58d2:	9ba58593          	addi	a1,a1,-1606 # 8288 <lock_release+0x212a>
  ...
  int continuous = 0;
    ...
    58fe:	94650513          	addi	a0,a0,-1722 # 8240 <lock_release+0x20e2>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    592a:	94a50513          	addi	a0,a0,-1718 # 8270 <lock_release+0x2112>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cc0:	94450513          	addi	a0,a0,-1724 # 8600 <digits>
    5cc4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d88:	00003b97          	auipc	s7,0x3
    5d8c:	878b8b93          	addi	s7,s7,-1928 # 8600 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5ecc:	73090913          	addi	s2,s2,1840 # 85f8 <lock_release+0x249a>
        while(*s != 0){
...
00000000000060f2 <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
    60f2:	1101                	addi	sp,sp,-32
    60f4:	ec06                	sd	ra,24(sp)
    60f6:	e822                	sd	s0,16(sp)
    60f8:	e426                	sd	s1,8(sp)
    60fa:	e04a                	sd	s2,0(sp)
    60fc:	1000                	addi	s0,sp,32
    60fe:	84aa                	mv	s1,a0
    6100:	892e                	mv	s2,a1
  ...
  return 0;
    ...
    6116:	4501                	li	a0,0
    6118:	60e2                	ld	ra,24(sp)
    611a:	6442                	ld	s0,16(sp)
    611c:	64a2                	ld	s1,8(sp)
    611e:	6902                	ld	s2,0(sp)
    6120:	6105                	addi	sp,sp,32
    6122:	8082                	ret
    (*start_routine)(arg);
    6124:	854a                	mv	a0,s2
    6126:	9482                	jalr	s1
    ...
    612e:	aa6080e7          	jalr	-1370(ra) # 5bd0 <exit>

0000000000006132 <lock_init>:

// Initialize lock
void lock_init(struct lock_t* lock) {
    6132:	1141                	addi	sp,sp,-16
    6134:	e422                	sd	s0,8(sp)
    6136:	0800                	addi	s0,sp,16
  lock->locked = 0;
    6138:	00052023          	sw	zero,0(a0) # 1000 <linktest+0x10a>
}
    613c:	6422                	ld	s0,8(sp)
    613e:	0141                	addi	sp,sp,16
    6140:	8082                	ret

0000000000006142 <lock_acquire>:
...
//    __sync_synchronize();
    ...
    6148:	4705                	li	a4,1
    614a:	87ba                	mv	a5,a4
    614c:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
    6150:	2781                	sext.w	a5,a5
    6152:	ffe5                	bnez	a5,614a <lock_acquire+0x8>
    __sync_synchronize();
    6154:	0ff0000f          	fence
}
    6158:	6422                	ld	s0,8(sp)
    615a:	0141                	addi	sp,sp,16
    615c:	8082                	ret

000000000000615e <lock_release>:

void lock_release(struct lock_t* lock) {
    615e:	1141                	addi	sp,sp,-16
    6160:	e422                	sd	s0,8(sp)
    6162:	0800                	addi	s0,sp,16
...
//    __sync_lock_release(&lock->locked, 0);
    __sync_lock_release(&lock->locked, 0);
    6168:	0f50000f          	fence	iorw,ow
    616c:	0805202f          	amoswap.w	zero,zero,(a0)
//
}
    6170:	6422                	ld	s0,8(sp)
    6172:	0141                	addi	sp,sp,16
    6174:	8082                	ret
