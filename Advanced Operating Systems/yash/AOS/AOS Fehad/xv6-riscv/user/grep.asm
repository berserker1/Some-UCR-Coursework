...
00000000000001ee <main>:
{
 ...
 262:	89258593          	addi	a1,a1,-1902 # af0 <lock_release+0x24>
 266:	4509                	li	a0,2
 ...
 298:	87c50513          	addi	a0,a0,-1924 # b10 <lock_release+0x44>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6fa:	43ab8b93          	addi	s7,s7,1082 # b30 <digits>
 ...
 83a:	2f290913          	addi	s2,s2,754 # b28 <lock_release+0x5c>
        while(*s != 0){
...
0000000000000a60 <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 a9c:	aa6080e7          	jalr	-1370(ra) # 53e <exit>

0000000000000aa0 <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 aa4:	0800                	addi	s0,sp,16
  lock->locked = 0;
 aa6:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 aaa:	6422                	ld	s0,8(sp)
 aac:	0141                	addi	sp,sp,16
 aae:	8082                	ret

0000000000000ab0 <lock_acquire>:
...
//    __sync_synchronize();
 ...
 ab6:	4705                	li	a4,1
 ab8:	87ba                	mv	a5,a4
 aba:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 abe:	2781                	sext.w	a5,a5
 ac0:	ffe5                	bnez	a5,ab8 <lock_acquire+0x8>
    __sync_synchronize();
 ac2:	0ff0000f          	fence
}
 ac6:	6422                	ld	s0,8(sp)
...
//    __sync_lock_release(&lock->locked, 0);
    __sync_lock_release(&lock->locked, 0);
 ad6:	0f50000f          	fence	iorw,ow
 ada:	0805202f          	amoswap.w	zero,zero,(a0)
//
}
 ade:	6422                	ld	s0,8(sp)
